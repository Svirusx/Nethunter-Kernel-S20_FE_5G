...
static void samsung_panel_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->panel_func.get_gamma_V_size = get_gamma_V_size_S6E3HA9_AMB644WF01;
	vdd->panel_func.convert_GAMMA_to_V = convert_GAMMA_to_V_S6E3HA9_AMB644WF01;
	vdd->panel_func.convert_V_to_GAMMA = convert_V_to_GAMMA_S6E3HA9_AMB644WF01;
