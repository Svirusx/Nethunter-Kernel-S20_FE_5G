...
#include "ss_dsi_smart_dimming_S6E3FA7_AMS628RF01.h"
...
static int get_gradation_offset(int table_index, int index, int panel_revision)
{
	...
	case 'C' ... 'H':
	default:
		ret = gradation_offset_revC[table_index][index];
		break;
	}
...
static int get_rgb_offset(int table_index, int index, int panel_revision)
{
	...
	case 'C' ... 'H':
	default:
		ret = rgb_offset_revC[table_index][index];
		break;
	}
...
struct smartdim_conf *smart_get_conf_S6E3FA7_AMS628RF01(void)
{
...
struct smartdim_conf *smart_get_conf_S6E3FA7_AMS628RF01_hmt(void)
{
