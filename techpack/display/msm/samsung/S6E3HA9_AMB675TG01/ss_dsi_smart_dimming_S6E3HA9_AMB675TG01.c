...
#include "ss_dsi_smart_dimming_S6E3HA9_AMB675TG01.h"
...
static void set_max_lux_table(int ldi_revision)
{
	...
	v255_10bit[R] = (center_gamma[V255][R] & BIT(9)) >> 4;
	v255_10bit[G] = (center_gamma[V255][G] & BIT(9)) >> 6;
	v255_10bit[B] = (center_gamma[V255][B] & BIT(9)) >> 8;

	v255_9bit[R] = (center_gamma[V255][R] & BIT(8)) >> 4;
	v255_9bit[G] = (center_gamma[V255][G] & BIT(8)) >> 6;
...
static void mtp_sorting(struct SMART_DIM *psmart)
{
	...
	/* V255 */
	cnt = 0;
	v255_10bit[R] = !!(pfrom[cnt] & BIT(5));
	v255_10bit[G] = !!(pfrom[cnt] & BIT(3));
	v255_10bit[B] = !!(pfrom[cnt] & BIT(1));

	v255_9bit[R] = !!(pfrom[cnt] & BIT(4));
	v255_9bit[G] = !!(pfrom[cnt] & BIT(2));
...
struct smartdim_conf *smart_get_conf_S6E3HA9_AMB675TG01(void)
{
...
struct smartdim_conf *smart_get_conf_S6E3HA9_AMB675TG01_hmt(void)
{
