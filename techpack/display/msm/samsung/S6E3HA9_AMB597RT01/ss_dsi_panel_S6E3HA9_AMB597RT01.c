...
*/
#include "ss_dsi_panel_S6E3HA9_AMB597RT01.h"
#include "ss_dsi_mdnie_S6E3HA9_AMB597RT01.h"
#include "ss_dsi_interpolation_S6E3HA9_AMB597RT01.h"
...
//	br_interpolation_generate_event(vdd, GEN_HBM_INTERPOLATION_ELVSS, &hbm_etc_cmds->cmds[1].msg.tx_buf[3]);
	...
	*/
	...
	//if (vdd->gradual_acl_val) { => temp off
	if (0) {
...
static int ss_irc_read(struct samsung_display_driver_data *vdd)
{
	...
	memcpy(&set->cmds->msg.tx_buf[2], vdd->br.irc_otp, NUM_IRC_OTP);
...
static struct dsi_panel_cmd_set *ss_acl_on(struct samsung_display_driver_data *vdd, int *level_key)
{
	...
	*/
	...
	else if (vdd->mdnie.mdnie_tune_state_dsi->mdnie_app == GALLERY_APP)
		pcmds->cmds[0].msg.tx_buf[2] = 0x44;
	else
...
static void samsung_panel_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->panel_func.samsung_smart_get_conf = smart_get_conf_S6E3HA9_AMB597RT01;

	/* GAMMA FLASH */
	vdd->panel_func.gen_hbm_interpolation_gamma = gen_hbm_interpolation_gamma_S6E3HA9_AMB597RT01;
	vdd->panel_func.gen_hbm_interpolation_irc = gen_hbm_interpolation_irc_S6E3HA9_AMB597RT01;
	vdd->panel_func.gen_normal_interpolation_irc = gen_normal_interpolation_irc_S6E3HA9_AMB597RT01;
	vdd->panel_func.samsung_flash_gamma_support = flash_gamma_support_S6E3HA9_AMB597RT01;
	vdd->panel_func.samsung_interpolation_init = init_interpolation_S6E3HA9_AMB597RT01;
	...
	vdd->panel_func.samsung_smart_get_conf_hmt = smart_get_conf_S6E3HA9_AMB597RT01_hmt;
...
static int __init samsung_panel_initialize(void)
{
	...
	char panel_string[] = "ss_dsi_panel_S6E3HA9_AMB597RT01_WQHD";
