...
*/
#include "ss_dsi_panel_S6E3HAB_AMB687TZ01.h"
#include "ss_dsi_mdnie_S6E3HAB_AMB687TZ01.h"
#include "ss_dsi_interpolation_S6E3HAB_AMB687TZ01.h"
...
static struct dsi_panel_cmd_set *ss_hbm_etc(struct samsung_display_driver_data *vdd, int *level_key)
{
	...
	/* flash write error, force write 0x01 0xE4 */
	hbm_etc_cmds->cmds[2].msg.tx_buf[1] = 0x01;
	hbm_etc_cmds->cmds[2].msg.tx_buf[2] = 0xE4;
	hbm_etc_cmds->cmds[2].msg.tx_buf[3] = 0x01;
	hbm_etc_cmds->cmds[2].msg.tx_buf[4] = 0xE4;
...
static void samsung_panel_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->panel_func.samsung_smart_get_conf = smart_get_conf_S6E3HAB_AMB687TZ01;

	/* GAMMA FLASH */
	vdd->panel_func.gen_hbm_interpolation_gamma = gen_hbm_interpolation_gamma_S6E3HAB_AMB687TZ01;
	vdd->panel_func.gen_hbm_interpolation_irc = gen_hbm_interpolation_irc_S6E3HAB_AMB687TZ01;
	vdd->panel_func.gen_normal_interpolation_irc = gen_normal_interpolation_irc_S6E3HAB_AMB687TZ01;
	vdd->panel_func.samsung_flash_gamma_support = flash_gamma_support_S6E3HAB_AMB687TZ01;
	vdd->panel_func.samsung_interpolation_init = init_interpolation_S6E3HAB_AMB687TZ01;
	vdd->panel_func.force_use_table_for_hmd = table_gamma_update_hmd_S6E3HAB_AMB687TZ01;
	vdd->panel_func.get_gamma_V_size = get_gamma_V_size_S6E3HAB_AMB687TZ01;
	...
	vdd->panel_func.samsung_smart_get_conf_hmt = smart_get_conf_S6E3HAB_AMB687TZ01_hmt;
...
static int __init samsung_panel_initialize(void)
{
	...
	char panel_string[] = "ss_dsi_panel_S6E3HAB_AMB687TZ01_WQHD";
