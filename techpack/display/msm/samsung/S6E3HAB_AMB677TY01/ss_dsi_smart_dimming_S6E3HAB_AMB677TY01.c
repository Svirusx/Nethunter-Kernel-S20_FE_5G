...
*/
static void mtp_sorting(unsigned char* src, int (*dst)[RGB_MAX], bool negative)
{
	int i, j;
	u8 v255_10bit[RGB_MAX];
	u8 v255_9bit[RGB_MAX];
...
struct smartdim_conf *smart_get_conf_S6E3HAB_AMB677TY01(void)
{
...
struct smartdim_conf *smart_get_conf_S6E3HAB_AMB677TY01_hmt(void)
{
