...
void phydm_init_debug_settingx(struct dm_struct *dm)
{
	...
	phydm_reset_rx_rate_distributionx(dm);
}
...
void phydm_bb_dbg_port_header_selx(void *dm_void, u32 header_idx)
{
	...
	if (dm->support_ic_type & ODM_IC_11AC_SERIES) {
		odm_set_bb_regx(dm, R_0x8f8, 0x3c00000, header_idx);
...
void phydm_bb_dbg_port_clock_enx(void *dm_void, u8 enable)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u32 reg_value = 0;
	...
	if (dm->support_ic_type &
		...
		odm_set_bb_regx(dm, R_0x198c, 0x7, reg_value);
	}
}
...
u32 phydm_get_bb_dbg_port_idx(void *dm_void)
{
	...
	if (dm->support_ic_type & ODM_IC_11AC_SERIES) {
		phydm_bb_dbg_port_clock_enx(dm, true);
		val = odm_get_bb_regx(dm, R_0x8fc, MASKDWORD);
	} else if (dm->support_ic_type & ODM_IC_JGR3_SERIES) {
		val = odm_get_bb_regx(dm, R_0x1c3c, 0xfff00);
	} else { /*@if (dm->support_ic_type & ODM_IC_11N_SERIES)*/
		val = odm_get_bb_regx(dm, R_0x908, MASKDWORD);
	}
	return val;
}
...
u8 phydm_set_bb_dbg_portx(void *dm_void, u8 curr_dbg_priority, u32 debug_port)
{
	...
	if (curr_dbg_priority > dm->pre_dbg_priority) {
		if (dm->support_ic_type & ODM_IC_11AC_SERIES) {
			...
			odm_set_bb_regx(dm, R_0x8fc, MASKDWORD, debug_port);
		} else if (dm->support_ic_type & ODM_IC_JGR3_SERIES) {
			odm_set_bb_regx(dm, R_0x1c3c, 0xfff00, debug_port);

		} else { /*@if (dm->support_ic_type & ODM_IC_11N_SERIES)*/
			odm_set_bb_regx(dm, R_0x908, MASKDWORD, debug_port);
		}
...
void phydm_release_bb_dbg_portx(void *dm_void)
{
	...
	phydm_bb_dbg_port_clock_enx(dm, false);
	phydm_bb_dbg_port_header_selx(dm, 0);
...
u32 phydm_get_bb_dbg_port_valx(void *dm_void)
{
	...
	if (dm->support_ic_type & ODM_IC_11AC_SERIES)
		dbg_port_value = odm_get_bb_regx(dm, R_0xfa0, MASKDWORD);
	else if (dm->support_ic_type & ODM_IC_JGR3_SERIES)
		dbg_port_value = odm_get_bb_regx(dm, R_0x2dbc, MASKDWORD);
	else /*@if (dm->support_ic_type & ODM_IC_11N_SERIES)*/
		dbg_port_value = odm_get_bb_regx(dm, R_0xdf4, MASKDWORD);
...
void phydm_bb_hw_dbg_infox_n(void *dm_void, u32 *_used, char *output,
			    u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u32 used = *_used;
	...
	/*@AGC result*/
	value32 = odm_get_bb_regx(dm, R_0xdd0, MASKDWORD);
	...
	/*SNR report*/
	value32 = odm_get_bb_regx(dm, R_0xdd4, MASKDWORD);
	...
	value32 = odm_get_bb_regx(dm, R_0xdd8, MASKDWORD);
...
#else
	/*@CFO Report Info*/
	odm_set_bb_regx(dm, R_0xd00, BIT(26), 1);

	/*Short CFO*/
	value32 = odm_get_bb_regx(dm, R_0xdac, MASKDWORD);
	value32_1 = odm_get_bb_regx(dm, R_0xdb0, MASKDWORD);
	...
	/*SCFO*/
	value32 = odm_get_bb_regx(dm, R_0xdb8, MASKDWORD);
	value32_1 = odm_get_bb_regx(dm, R_0xdb4, MASKDWORD);
	...
	value32 = odm_get_bb_regx(dm, R_0xdbc, MASKDWORD);
	value32_1 = odm_get_bb_regx(dm, R_0xde0, MASKDWORD);
...
#if (RTL8822B_SUPPORT)
void phydm_bb_hw_dbg_infox_8822b(void *dm_void, u32 *_used, char *output,
				u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u32 used = *_used;
	...
	PDM_SNPF(out_len, used, output + used, out_len - used,
		 "\r\n %-35s = %d.%.4d", "condi_num",
		 condi_num >> 4, phydm_show_fraction_numx(condi_num & 0xf, 4));
...
void phydm_bb_hw_dbg_infox_ac(void *dm_void, u32 *_used, char *output,
			     u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u32 used = *_used;
	...
	PDM_SNPF(out_len, used, output + used, out_len - used,
		 "\r\n %-35s = %d", "OFDM CCA cnt",
		 odm_get_bb_regx(dm, R_0xf08, 0xFFFF0000));

	PDM_SNPF(out_len, used, output + used, out_len - used,
		 "\r\n %-35s = %d", "OFDM SBD Fail cnt",
		 odm_get_bb_regx(dm, R_0xfd0, 0xFFFF));

	value32 = odm_get_bb_regx(dm, R_0xfc4, MASKDWORD);
	PDM_SNPF(out_len, used, output + used, out_len - used,
	...
	PDM_SNPF(out_len, used, output + used, out_len - used,
		 "\r\n %-35s = %d", "CCK CCA cnt",
		 odm_get_bb_regx(dm, R_0xfcc, 0xFFFF));

	value32 = odm_get_bb_regx(dm, R_0xfbc, MASKDWORD);
	PDM_SNPF(out_len, used, output + used, out_len - used,
		 "\r\n %-35s = %d / %d",
	...
	PDM_SNPF(out_len, used, output + used, out_len - used,
		 ...
		 odm_get_bb_regx(dm, R_0xfc0, (0xFFFF0000 >> 16)),
		 odm_get_bb_regx(dm, R_0xfc8, 0xFFFF));

	/*@ [PostFFT Info] =================================================*/
	value32 = odm_get_bb_regx(dm, R_0xf8c, MASKDWORD);
	rxevm_0 = (s8)((value32 & MASKBYTE2) >> 16);
	rxevm_0 /= 2;
	if (rxevm_0 < -63)
		rxevm_0 = 0;
	...
	rxevm_1 = (s8)((value32 & MASKBYTE3) >> 24);
	rxevm_1 /= 2;
	value32 = odm_get_bb_regx(dm, R_0xf88, MASKDWORD);
	...
	/*@ [L-SIG Content] =================================================*/
	value32 = odm_get_bb_regx(dm, R_0xf20, MASKDWORD);
	...
	PDM_SNPF(out_len, used, output + used, out_len - used,
		 "\r\n %-35s = %d M", "rate",
		 phydm_get_l_sig_ratex(dm, (u8)(value32 & 0x0f)));
	...
	if (rx_ht == AD_HT_MODE) {
	/*@ [HT SIG 1] ======================================================*/
		value32 = odm_get_bb_regx(dm, R_0xf2c, MASKDWORD);
	...
	/*@ [HT SIG 2] ======================================================*/
		value32 = odm_get_bb_regx(dm, R_0xf30, MASKDWORD);
	...
	/*@ [VHT SIG B] ====================================================*/
		value32 = odm_get_bb_regx(dm, R_0xf34, MASKDWORD);
...
void phydm_bb_hw_dbg_infox_jgr3(void *dm_void, u32 *_used, char *output,
			       u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u32 used = *_used;
	...
	value32 = odm_get_bb_regx(dm, R_0x2c20, MASKDWORD);
	...
	PDM_SNPF(out_len, used, output + used, out_len - used,
		 "\r\n %-35s = %d", "CCK CCA cnt",
		 odm_get_bb_regx(dm, R_0x2c08, 0xFFFF));

	PDM_SNPF(out_len, used, output + used, out_len - used,
		 "\r\n %-35s = %d", "OFDM CCA cnt",
		 odm_get_bb_regx(dm, R_0x2c08, 0xFFFF0000));

	PDM_SNPF(out_len, used, output + used, out_len - used,
		 "\r\n %-35s = %d", "OFDM SBD Fail cnt",
		 odm_get_bb_regx(dm, R_0x2d20, 0xFFFF0000));

	PDM_SNPF(out_len, used, output + used, out_len - used,
		 "\r\n %-35s = %d / %d",
		 "LSIG (parity Fail/rate Illegal) cnt",
		 odm_get_bb_regx(dm, R_0x2d04, 0xFFFF0000),
		 odm_get_bb_regx(dm, R_0x2d08, 0xFFFF));

	value32 = odm_get_bb_regx(dm, R_0x2d10, MASKDWORD);
	PDM_SNPF(out_len, used, output + used, out_len - used,
		 "\r\n %-35s = %d / %d", "HT/VHT MCS NOT SUPPORT cnt",
		 value32 & 0xFFFF, ((value32 & 0xFFFF0000) >> 16));

	value32 = odm_get_bb_regx(dm, R_0x2d0c, MASKDWORD);
	PDM_SNPF(out_len, used, output + used, out_len - used,
		 "\r\n %-35s = %d / %d", "VHT SIGA/SIGB CRC8 Fail cnt",
		 value32 & 0xFFFF, ((value32 & 0xFFFF0000) >> 16));
	/*@ [L-SIG Content] =================================================*/
	...
	if (rx_ht == AD_HT_MODE) {
	/*@ [HT SIG 1] ======================================================*/
		value32 = odm_get_bb_regx(dm, R_0x2c2c, MASKDWORD);
		...
		PDM_SNPF(out_len, used, output + used, out_len - used,
			 ...
			 hmcss, hrx_bw, h_length);
	/*@ [HT SIG 2] ======================================================*/
		value32 = odm_get_bb_regx(dm, R_0x2c30, MASKDWORD);
		smooth = (u8)(value32 & 0x01);
		htsound = (u8)((value32 & 0x02) >> 1);
		rsv = (u8)((value32 & 0x04) >> 2);
		agg = (u8)((value32 & 0x08) >> 3);
	...
	/*@ [VHT SIG B] ====================================================*/
		value32 = odm_get_bb_regx(dm, R_0x2c34, MASKDWORD);
...
void phydm_bb_hw_dbg_infox(void *dm_void, char input[][16], u32 *_used,
			  char *output, u32 *_out_len)
{
	...
	#if (ODM_IC_11N_SERIES_SUPPORT)
	case PHYDM_IC_N:
		phydm_bb_hw_dbg_infox_n(dm, &used, output, &out_len);
		break;
	#endif

	#if (ODM_IC_11AC_SERIES_SUPPORT)
	case PHYDM_IC_AC:
		phydm_bb_hw_dbg_infox_ac(dm, &used, output, &out_len);
		phydm_reset_bb_hw_cntx(dm);
		#if (RTL8822B_SUPPORT)
		phydm_bb_hw_dbg_infox_8822b(dm, &used, output, &out_len);
		#endif
		break;
	#endif
	...
	#ifdef PHYDM_IC_JGR3_SERIES_SUPPORT
	case PHYDM_IC_JGR3:
		phydm_bb_hw_dbg_infox_jgr3(dm, &used, output, &out_len);
		phydm_reset_bb_hw_cntx(dm);
		break;
	#endif
	default:
...
void phydm_dm_summaryx_cli_win(void *dm_void, char *buf, u8 macid)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
...
void phydm_basic_dbg_msg_cli_win(void *dm_void, char *buf)
{
	...
	if (dm->is_linked) {
		...
		phydm_print_ratex_2_buff(dm, dm->rx_rate, dbg_buf, PHYDM_SNPRINT_SIZE);
		...
		phydm_print_ratex_2_buff(dm, dm->phy_dbg_info.beacon_phy_rate, dbg_buf, PHYDM_SNPRINT_SIZE);
		...
		/*Show phydm_rx_rate_distributionx;*/
		RT_SPRINTF(buf, DBGM_CLI_BUF_SIZE, "\r\n [RxRate Cnt] =============>");
		RT_PRINT(buf);
		...
		RT_PRINT(buf);
#if 1
		phydm_get_avg_phystatus_valx(dm);
		...
		for (i = 0; i <= 4; i++) {
			...
			odm_memory_setx(dm, tmp_rssi_avg, 0, 4);
			odm_memory_setx(dm, tmp_snr_avg, 0, 4);
			odm_memory_setx(dm, tmp_evm_avg, 0, 4);

			#if (defined(PHYDM_COMPILE_ABOVE_4SS))
			if (i == 4) {
				rate_type = "[4-SS]";
				tmp_cnt = dbg_s->rssi_4ss_cnt;
				odm_move_memoryx(dm, tmp_rssi_avg, dbg_avg->rssi_4ss_avg, dm->num_rf_path);
				odm_move_memoryx(dm, tmp_snr_avg, dbg_avg->snr_4ss_avg, dm->num_rf_path);
				odm_move_memoryx(dm, tmp_evm_avg, dbg_avg->evm_4ss_avg, 4);
			} else
			#endif
			...
			if (i == 3) {
				...
				odm_move_memoryx(dm, tmp_rssi_avg, dbg_avg->rssi_3ss_avg, dm->num_rf_path);
				odm_move_memoryx(dm, tmp_snr_avg, dbg_avg->snr_3ss_avg, dm->num_rf_path);
				odm_move_memoryx(dm, tmp_evm_avg, dbg_avg->evm_3ss_avg, 3);
			} else
			#endif
			...
			if (i == 2) {
				...
				odm_move_memoryx(dm, tmp_rssi_avg, dbg_avg->rssi_2ss_avg, dm->num_rf_path);
				odm_move_memoryx(dm, tmp_snr_avg, dbg_avg->snr_2ss_avg, dm->num_rf_path);
				odm_move_memoryx(dm, tmp_evm_avg, dbg_avg->evm_2ss_avg, 2);
			} else
			#endif
			if (i == 1) {
				rate_type = "[1-SS]";
				tmp_cnt = dbg_s->rssi_1ss_cnt;
				odm_move_memoryx(dm, tmp_rssi_avg, dbg_avg->rssi_1ss_avg, dm->num_rf_path);
				odm_move_memoryx(dm, tmp_snr_avg, dbg_avg->snr_1ss_avg, dm->num_rf_path);
				odm_move_memoryx(dm, tmp_evm_avg, &dbg_avg->evm_1ss_avg, 1);
			} else {
				rate_type = "[L-OFDM]";
				tmp_cnt = dbg_s->rssi_ofdm_cnt;
				odm_move_memoryx(dm, tmp_rssi_avg, dbg_avg->rssi_ofdm_avg, dm->num_rf_path);
				odm_move_memoryx(dm, tmp_snr_avg, dbg_avg->snr_ofdm_avg, dm->num_rf_path);
				odm_move_memoryx(dm, tmp_evm_avg, &dbg_avg->evm_ofdm_avg, 1);
			}
...
#endif
#endif
		phydm_reset_phystatus_statisticx(dm);
		/*@----------------------------------------------------------*/
		...
		for (macid = 0; macid < ODM_ASSOCIATE_ENTRY_NUM; macid++) {
			...
			if (is_sta_active(entry)) {
				phydm_print_ratex_2_buff(dm, entry->ra_info.curr_tx_rate, dbg_buf, PHYDM_SNPRINT_SIZE);
		...
		if (dm->support_ic_type == ODM_RTL8822B) {
			RT_SPRINTF(buf, DBGM_CLI_BUF_SIZE, "\r\n Condi_Num=((%d.%.4d))",
				   ...
				   phydm_show_fraction_numx(dm->phy_dbg_info.condi_num & 0xf, 4));
			RT_PRINT(buf);
		}
		#endif
	...
	phydm_dm_summaryx_cli_win(dm, buf, target_macid);
}
	...
	struct dm_struct *dm)
{
	...
	if (sbd_state == 0) {
		...
		if (pkt_cnt % 5 == 0) {
			odm_set_timerx(dm, &dm->sbdcnt_timer, 0); /*@ms*/
			sbd_state = 1;
		}
	} else { /*read counter*/
		value32 = odm_get_bb_regx(dm, R_0xf98, MASKDWORD);
...
void phydm_reset_rx_rate_distributionx(struct dm_struct *dm)
{
	...
	odm_memory_setx(dm, &dbg->num_qry_legacy_pkt[0], 0,
		       (LEGACY_RATE_NUM * 2));
	odm_memory_setx(dm, &dbg->num_qry_ht_pkt[0], 0,
		       (HT_RATE_NUM * 2));
	odm_memory_setx(dm, &dbg->num_qry_pkt_sc_20m[0], 0,
		       (LOW_BW_RATE_NUM * 2));
...
#if (ODM_IC_11AC_SERIES_SUPPORT || defined(PHYDM_IC_JGR3_SERIES_SUPPORT))
	odm_memory_setx(dm, &dbg->num_qry_vht_pkt[0], 0, VHT_RATE_NUM * 2);
	odm_memory_setx(dm, &dbg->num_qry_pkt_sc_40m[0], 0, LOW_BW_RATE_NUM * 2);
	#if (ODM_PHY_STATUS_NEW_TYPE_SUPPORT == 1) || (defined(PHYSTS_3RD_TYPE_SUPPORT))
	odm_memory_setx(dm, &dbg->num_mu_vht_pkt[0], 0, VHT_RATE_NUM * 2);
	#endif
...
u16 phydm_rx_avg_phy_rate(void *dm_void)
{
	...
	if (dbg->ht_pkt_not_zero) {
		...
		for (i = 0; i < rate_num; i++) {
			rate = phy_rate_tablex[i + rate_base] << *dm->band_width;
	...
	if (dbg->low_bw_40_occur) {
		for (i = 0; i < LOW_BW_RATE_NUM; i++) {
			rate = phy_rate_tablex[i + rate_base]
			       << CHANNEL_WIDTH_40;
...
void phydm_print_hist_2_bufx(void *dm_void, u16 *val, u16 len, char *buf,
			    u16 buf_size)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
...
void phydm_nss_hitogramx(void *dm_void, enum PDM_RATE_TYPE rate_type)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	...
	u8 i = 0;
	u8 ss = phydm_rate_type_2_num_ssx(dm, rate_type);
	...
	for (i = 0; i < ss; i++) {
		...
		phydm_print_hist_2_bufx(dm, evm_hist, h_size, buf, buf_size);
		PHYDM_DBG(dm, DBG_CMN, "[%d-SS][EVM][%d]=%s\n", ss, i, buf);
		phydm_print_hist_2_bufx(dm, snr_hist, h_size, buf, buf_size);
...
/*@===[Threshold]=============================================================*/
	phydm_print_hist_2_bufx(dm, dbg_i->evm_hist_th, th_size, buf, buf_size);
	PHYDM_DBG(dm, DBG_CMN, "%-16s=%s\n", "[EVM_TH]", buf);

	phydm_print_hist_2_bufx(dm, dbg_i->snr_hist_th, th_size, buf, buf_size);
	PHYDM_DBG(dm, DBG_CMN, "%-16s=%s\n", "[SNR_TH]", buf);
/*@===[OFDM]==================================================================*/
	if (dbg_s->rssi_ofdm_cnt) {
		phydm_print_hist_2_bufx(dm, dbg_s->evm_ofdm_hist, PHY_HIST_SIZE,
				       buf, buf_size);
		PHYDM_DBG(dm, DBG_CMN, "%-14s=%s\n", "[OFDM][EVM]", buf);

		phydm_print_hist_2_bufx(dm, dbg_s->snr_ofdm_hist, PHY_HIST_SIZE,
				       buf, buf_size);
		PHYDM_DBG(dm, DBG_CMN, "%-14s=%s\n", "[OFDM][SNR]", buf);
	}
/*@===[1-SS]==================================================================*/
	if (dbg_s->rssi_1ss_cnt)
		phydm_nss_hitogramx(dm, PDM_1SS);
/*@===[2-SS]==================================================================*/
	#if (defined(PHYDM_COMPILE_ABOVE_2SS))
	if ((dm->support_ic_type & PHYDM_IC_ABOVE_2SS) && dbg_s->rssi_2ss_cnt)
		phydm_nss_hitogramx(dm, PDM_2SS);
	#endif
/*@===[3-SS]==================================================================*/
	#if (defined(PHYDM_COMPILE_ABOVE_3SS))
	if ((dm->support_ic_type & PHYDM_IC_ABOVE_3SS) && dbg_s->rssi_3ss_cnt)
		phydm_nss_hitogramx(dm, PDM_3SS);
	#endif
/*@===[4-SS]==================================================================*/
	#if (defined(PHYDM_COMPILE_ABOVE_4SS))
	if (dm->support_ic_type & PHYDM_IC_ABOVE_4SS && dbg_s->rssi_4ss_cnt)
		phydm_nss_hitogramx(dm, PDM_4SS);
	#endif
}
...
void phydm_avg_phy_val_nss(void *dm_void, u8 nss)
{
	...
	odm_memory_setx(dm, &evm_rpt_show[0], 0, RF_PATH_MEM_SIZE);
...
void phydm_get_phy_statisticx(void *dm_void)
{
	...
	phydm_rx_rate_distributionx(dm);
	phydm_reset_rx_rate_distributionx(dm);

	phydm_show_phy_hitogramx(dm);
	phydm_get_avg_phystatus_valx(dm);
	phydm_reset_phystatus_statisticx(dm);
};

void phydm_basic_dbg_msg_linkedx(void *dm_void)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	struct phydm_cfo_track_struct *cfo_t = &dm->dm_cfo_track;
...
/* @Condition number */
	...
	if (dm->support_ic_type == ODM_RTL8822B) {
		PHYDM_DBG(dm, DBG_CMN, "Condi_Num=((%d.%.4d)), %d\n",
			  dbg_t->condi_num >> 4,
			  phydm_show_fraction_numx(dbg_t->condi_num & 0xf, 4),
			  dbg_t->condi_num);
	}
#endif
	...
	if (dm->support_ic_type & PHYSTS_3RD_TYPE_IC) {
		PHYDM_DBG(dm, DBG_CMN, "Condi_Num=((%d.%4d dB))\n",
			  dbg_t->condi_num >> 1,
			  phydm_show_fraction_numx(dbg_t->condi_num & 0x1, 1));
	}
#endif
...
void phydm_basic_dbg_messagex(void *dm_void)
{
	...
	if (dm->is_linked)
		phydm_basic_dbg_msg_linkedx(dm);
	else
...
void phydm_basic_profilex(void *dm_void, u32 *_used, char *output, u32 *_out_len)
{
#ifdef CONFIG_PHYDM_DEBUG_FUNCTION
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	char *cut = NULL;
...
/*@jj add 20170822*/
	...
	PDM_SNPF(out_len, used, output + used, out_len - used, "  %-35s: %s\n",
		 "Cut Ver", cut);
	PDM_SNPF(out_len, used, output + used, out_len - used, "  %-35s: %d\n",
		 "PHY Para Ver", odm_get_hw_img_versionx(dm));
	PDM_SNPF(out_len, used, output + used, out_len - used, "  %-35s: %d\n",
			   ...
			   u32 fw_dbg_comp, u32 monitor_mode, u32 macid)
{
	...
	odm_fill_h2c_cmdx(dm, PHYDM_H2C_FW_TRACE_EN, cmd_length, h2c_parameter);
}

void phydm_get_per_path_txagcx(void *dm_void, u8 path, u32 *_used, char *output,
			      u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u8 rate_idx = 0;
...
void phydm_get_txagcx(void *dm_void, u32 *_used, char *output, u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u32 used = *_used;
	u32 out_len = *_out_len;
	...
	PDM_SNPF(out_len, used, output + used, out_len - used, "%-35s\n",
		 "path-A====================");
	phydm_get_per_path_txagcx(dm, RF_PATH_A, &used, output, &out_len);

	/* path-B */
	PDM_SNPF(out_len, used, output + used, out_len - used, "\n%-35s\n",
		 "path-B====================");
	phydm_get_per_path_txagcx(dm, RF_PATH_B, &used, output, &out_len);

	/* path-C */
	PDM_SNPF(out_len, used, output + used, out_len - used, "\n%-35s\n",
		 "path-C====================");
	phydm_get_per_path_txagcx(dm, RF_PATH_C, &used, output, &out_len);

	/* path-D */
	PDM_SNPF(out_len, used, output + used, out_len - used, "\n%-35s\n",
		 "path-D====================");
	phydm_get_per_path_txagcx(dm, RF_PATH_D, &used, output, &out_len);

	*_used = used;
	*_out_len = out_len;
}

void phydm_set_txagcx(void *dm_void, u32 *const val, u32 *_used,
		     char *output, u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u32 used = *_used;
...
void phydm_shift_txagcx(void *dm_void, u32 *const val, u32 *_used, char *output,
		       u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u32 used = *_used;
...
void phydm_set_txagcx_dbg(void *dm_void, char input[][16], u32 *_used,
			 char *output, u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u32 used = *_used;
	...
	if ((strcmp(input[1], help) == 0)) {
		...
		config_phydm_write_txagc_8822c(dm, var1[3],
					       ...
					       (u8)var1[2]);
		#else
		phydm_set_txagcx(dm, (u32 *)var1, &used, output, &out_len);
		#endif
		dm->is_disable_phy_api = true;
	} else if (var1[0] == 2) {
		PHYDM_SSCANF(input[4], DCMD_HEX, &var1[3]);
		dm->is_disable_phy_api = false;
		phydm_shift_txagcx(dm, (u32 *)var1, &used, output, &out_len);
		dm->is_disable_phy_api = true;
	}
	#ifdef CONFIG_TXAGC_DEBUG_8822C
	else if (var1[0] == 3) {
		...
		dm->is_disable_phy_api = false;
		config_phydm_set_txagcx_to_hw_8822c(dm);
		dm->is_disable_phy_api = true;
	}
	#endif
...
void phydm_debug_tracex(void *dm_void, char input[][16], u32 *_used,
		       char *output, u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
...
void phydm_fw_debug_tracex(void *dm_void, char input[][16], u32 *_used,
			  char *output, u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u32 used = *_used;
	...
	if ((strcmp(input[1], help) == 0)) {
		...
		if (comp == 0) {
			...
			phydm_fw_trace_en_h2cx(dm, false, comp, val[2], val[3]);
		} else {
			dm->debug_components |= DBG_FW_TRACE;
			/*@H2C to enable C2H Msg*/
			phydm_fw_trace_en_h2cx(dm, true, comp, val[2], val[3]);
		}
	}
}

#if (ODM_IC_11N_SERIES_SUPPORT)
void phydm_dump_bb_regx_n(void *dm_void, u32 *_used, char *output, u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u32 addr = 0;
	u32 used = *_used;
	...
	for (addr = 0x800; addr < 0xfff; addr += 4) {
		PDM_VAST_SNPF(out_len, used, output + used, out_len - used,
			      "0x%03x 0x%08x\n",
			      addr, odm_get_bb_regx(dm, addr, MASKDWORD));
	}
...
#if (ODM_IC_11AC_SERIES_SUPPORT)
void phydm_dump_bb_regx_ac(void *dm_void, u32 *_used, char *output,
			  u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u32 addr = 0;
	...
	if (dm->rf_type > RF_2T2R) {
		for (addr = 0x1800; addr < 0x18ff; addr += 4)
			PDM_VAST_SNPF(out_len, used, output + used,
				      ...
				      addr,
				      odm_get_bb_regx(dm, addr, MASKDWORD));
	}
...
#ifdef PHYDM_IC_JGR3_SERIES_SUPPORT
void phydm_dump_bb_regx_jgr3(void *dm_void, u32 *_used, char *output,
			    u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u32 addr = 0;
...
void phydm_dump_bb_regx2_jgr3(void *dm_void, u32 *_used, char *output,
			     u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u32 addr = 0;
				    ...
				    char *output, u32 *_out_len)
{
	...
	state_bp = (u8)odm_get_bb_regx(dm, reg_idx, 0xf00000);
	odm_set_bb_regx(dm, reg_idx, 0x38000000, 0x5); /* @read en*/

	for (state = 0; state <= 0xf; state++) {
		odm_set_bb_regx(dm, reg_idx, 0xF00000, state);
		if (phydm_set_bb_dbg_portx(dm, DBGPORT_PRI_3, dbgport_idx)) {
			dbgport_val = phydm_get_bb_dbg_port_valx(dm);
	...
	odm_set_bb_regx(dm, reg_idx, 0xf00000, state_bp);
	odm_set_bb_regx(dm, reg_idx, 0x38000000, 0x6); /* @write en*/
...
void phydm_dump_bb_regx(void *dm_void, u32 *_used, char *output, u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u32 used = *_used;
	u32 out_len = *_out_len;
	...
	#ifdef PHYDM_IC_JGR3_SERIES_SUPPORT
	case PHYDM_IC_JGR3:
		phydm_dump_bb_regx_jgr3(dm, &used, output, &out_len);
		break;
	#endif

	#if (ODM_IC_11AC_SERIES_SUPPORT == 1)
	case PHYDM_IC_AC:
		phydm_dump_bb_regx_ac(dm, &used, output, &out_len);
		break;
	#endif

	#if (ODM_IC_11N_SERIES_SUPPORT == 1)
	case PHYDM_IC_N:
		phydm_dump_bb_regx_n(dm, &used, output, &out_len);
		break;
	#endif
...
void phydm_dump_rf_regx(void *dm_void, u32 *_used, char *output, u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u32 addr = 0;
	u32 used = *_used;
	...
	for (addr = 0; addr <= 0xFF; addr++) {
		reg = odm_get_rf_regx(dm, RF_PATH_A, addr, RFREG_MASK);
		PDM_VAST_SNPF(out_len, used, output + used, out_len - used,
			      "0x%02x 0x%05x\n", addr, reg);
		}
	...
	if (dm->rf_type > RF_1T1R) {
		...
		for (addr = 0; addr <= 0xFF; addr++) {
			reg = odm_get_rf_regx(dm, RF_PATH_B, addr, RFREG_MASK);
			PDM_VAST_SNPF(out_len, used, output + used,
	...
	if (dm->rf_type > RF_2T2R) {
		...
		for (addr = 0; addr <= 0xFF; addr++) {
			reg = odm_get_rf_regx(dm, RF_PATH_C, addr, RFREG_MASK);
			PDM_VAST_SNPF(out_len, used, output + used,
				      out_len - used, "0x%02x 0x%05x\n",
				      addr, reg);
		}
	...
	if (dm->rf_type > RF_3T3R) {
		...
		for (addr = 0; addr <= 0xFF; addr++) {
			reg = odm_get_rf_regx(dm, RF_PATH_D, addr, RFREG_MASK);
			PDM_VAST_SNPF(out_len, used, output + used,
				      out_len - used, "0x%02x 0x%05x\n",
				      addr, reg);
		}
...
void phydm_dump_mac_regx(void *dm_void, u32 *_used, char *output, u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u32 addr = 0;
	u32 used = *_used;
...
void phydm_dump_regx(void *dm_void, char input[][16], u32 *_used, char *output,
		    u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	char help[] = "-h";
	...
	if ((strcmp(input[1], help) == 0)) {
		...
		phydm_dump_mac_regx(dm, &used, output, &out_len);
		phydm_dump_bb_regx(dm, &used, output, &out_len);
		#ifdef PHYDM_IC_JGR3_SERIES_SUPPORT
		if (dm->ic_ip_series == PHYDM_IC_JGR3)
			phydm_dump_bb_regx2_jgr3(dm, &used, output, &out_len);
		#endif

		phydm_dump_rf_regx(dm, &used, output, &out_len);
	} else if (var1[0] == 1) {
		phydm_dump_bb_regx(dm, &used, output, &out_len);
	} else if (var1[0] == 2) {
		phydm_dump_rf_regx(dm, &used, output, &out_len);
...
void phydm_enable_big_jumpx(void *dm_void, char input[][16], u32 *_used,
			   char *output, u32 *_out_len)
{
#if (RTL8822B_SUPPORT)
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	...
	if (dm_value[0] == 0) {
		...
		odm_set_bb_regx(dm, R_0x8c8, 0xfe, val);
	} else {
...
void phydm_show_rx_ratex(void *dm_void, char input[][16], u32 *_used,
			char *output, u32 *_out_len)
{
...
void phydm_per_tone_evmx(void *dm_void, char input[][16], u32 *_used,
			char *output, u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u8 i, j;
	...
	for (j = 0; j < round; j++) {
		...
		if (*dm->band_width == CHANNEL_WIDTH_20) {
			for (tone_num = 228; tone_num <= 255; tone_num++) {
				odm_set_bb_regx(dm, R_0x8c4, 0xff8, tone_num);
				rxevm_sum_0 = 0;
				rxevm_sum_1 = 0;
				for (i = 0; i < avg_num; i++) {
					val = odm_read_4bytex(dm, R_0xf8c);
...
void phydm_bw_ch_adjustx(void *dm_void, char input[][16],
...
void phydm_ext_rf_element_ctrlx(void *dm_void, char input[][16], u32 *_used,
			       char *output, u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u32 val[10] = {0};
	...
	if (val[0] == 1) /*@ext switch*/ {
		phydm_set_ext_switchx(dm, val[1]);
	}
}

void phydm_print_dbgportx(void *dm_void, char input[][16], u32 *_used,
			 char *output, u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	char help[] = "-h";
	...
	if (phydm_set_bb_dbg_portx(dm, DBGPORT_PRI_3, var1[0])) {
		dbg_port_value = phydm_get_bb_dbg_port_valx(dm);
		phydm_release_bb_dbg_portx(dm);
...
void phydm_nss_hitogramx_mp(void *dm_void, enum PDM_RATE_TYPE rate_type,
			   u32 *_used, char *output, u32 *_out_len)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	struct odm_phy_dbg_info *dbg_i = &dm->phy_dbg_info;
		  ...
		  u32 *_out_len)
{
	...
	PDM_SNPF(out_len, used, output + used, out_len - used,
		 "%-16s=%s\n", "[SNR_TH]", buf);
	/*@===[OFDM]===*/
	phydm_nss_hitogramx_mp(dm, PDM_OFDM, &used, output, &out_len);
	/*@===[1-SS]===*/
	phydm_nss_hitogramx_mp(dm, PDM_1SS, &used, output, &out_len);
	/*@===[2-SS]===*/
	#if (defined(PHYDM_COMPILE_ABOVE_2SS))
	if (dm->support_ic_type & PHYDM_IC_ABOVE_2SS)
		phydm_nss_hitogramx_mp(dm, PDM_2SS, &used, output, &out_len);
	#endif
	/*@===[3-SS]===*/
	#if (defined(PHYDM_COMPILE_ABOVE_3SS))
	if (dm->support_ic_type & PHYDM_IC_ABOVE_3SS)
		phydm_nss_hitogramx_mp(dm, PDM_3SS, &used, output, &out_len);
	#endif
	/*@===[4-SS]===*/
	#if (defined(PHYDM_COMPILE_ABOVE_4SS))
	if (dm->support_ic_type & PHYDM_IC_ABOVE_4SS)
		phydm_nss_hitogramx_mp(dm, PDM_4SS, &used, output, &out_len);
	#endif
	/*@===[PHY Avg]======================================================*/
	phydm_get_avg_phystatus_valx(dm);
	PDM_SNPF(out_len, used, output + used, out_len - used,
	...
	for (i = 0; i <= 4; i++) {
		...
		case 4:
			rate_type = "[4-SS]";
			tmp_cnt = dbg_s->rssi_4ss_cnt;
			odm_move_memoryx(dm, tmp_rssi_avg,
					dbg_avg->rssi_4ss_avg, dm->num_rf_path);
			odm_move_memoryx(dm, tmp_snr_avg,
					dbg_avg->snr_4ss_avg, dm->num_rf_path);
			odm_move_memoryx(dm, tmp_evm_avg, dbg_avg->evm_4ss_avg,
					4);
			break;
		#endif
		#if (defined(PHYDM_COMPILE_ABOVE_3SS))
		case 3:
			...
			odm_move_memoryx(dm, tmp_evm_avg,
		...
		case 2:
			...
			odm_move_memoryx(dm, tmp_snr_avg, dbg_avg->snr_2ss_avg,
					dm->num_rf_path);
			odm_move_memoryx(dm, tmp_evm_avg,
...
struct phydm_command phy_dm_aryx[] = {
...
void phydm_cmdx_parser(struct dm_struct *dm, char input[][MAX_ARGV],
		      u32 input_num, u8 flag, char *output, u32 out_len)
{
	...
	u32 var1[10] = {0};
	u32 i;
	u32 phydm_ary_size = sizeof(phy_dm_aryx) / sizeof(struct phydm_command);
	...
	if (input_num) {
		for (i = 0; i < phydm_ary_size; i++) {
			if (strcmp(phy_dm_aryx[i].name, input[0]) == 0) {
				id = phy_dm_aryx[i].id;
				break;
			}
		}
	...
	case PHYDM_RF_CMD:
		halrf_cmd_parserx(dm, input, &used, output, &out_len, input_num);
		break;

	case PHYDM_DIG:
		phydm_digx_debug(dm, input, &used, output, &out_len);
		break;

	case PHYDM_RA:
		phydm_ra_debugx(dm, input, &used, output, &out_len);
		break;
	...
	case PHYDM_DEBUG:
		phydm_debug_tracex(dm, input, &used, output, &out_len);
		break;
	...
	case PHYDM_FW_DEBUG:
		phydm_fw_debug_tracex(dm, input, &used, output, &out_len);
		break;

	case PHYDM_SUPPORT_ABILITY:
		phydm_supportability_enx(dm, input, &used, output, &out_len);
		break;
	...
	case PHYDM_CH_BW:
		phydm_bw_ch_adjustx(dm, input, &used, output, &out_len);
		break;

	case PHYDM_PROFILE:
		phydm_basic_profilex(dm, &used, output, &out_len);
		break;

	case PHYDM_GET_TXAGC:
		phydm_get_txagcx(dm, &used, output, &out_len);
		break;

	case PHYDM_SET_TXAGC:
		phydm_set_txagcx_dbg(dm, input, &used, output, &out_len);
		break;

	case PHYDM_TRX_PATH:
		phydm_config_trx_pathx(dm, input, &used, output, &out_len);
		break;
	...
	case PHYDM_DUMP_REG:
		phydm_dump_regx(dm, input, &used, output, &out_len);
		break;

	case PHYDM_BIG_JUMP:
		phydm_enable_big_jumpx(dm, input, &used, output, &out_len);
		break;
	...
	case PHYDM_SHOW_RXRATE:
		phydm_show_rx_ratex(dm, input, &used, output, &out_len);
		break;

	case PHYDM_NBI_EN:
		phydm_nbi_debugx(dm, input, &used, output, &out_len);
		break;

	case PHYDM_CSI_MASK_EN:
		phydm_csi_debugx(dm, input, &used, output, &out_len);
		break;
	...
	case PHYDM_NHM:
		#ifdef NHM_SUPPORT
		phydm_nhm_dbgx(dm, input, &used, output, &out_len);
		#endif
		break;

	case PHYDM_CLM:
		#ifdef CLM_SUPPORT
		phydm_clm_dbgx(dm, input, &used, output, &out_len);
		#endif
		break;
	...
	case PHYDM_ENV_MNTR:
		phydm_env_mntr_dbgx(dm, input, &used, output, &out_len);
		break;

	case PHYDM_BB_INFO:
		phydm_bb_hw_dbg_infox(dm, input, &used, output, &out_len);
		break;
	/*
	case PHYDM_TXBF: {
	...
	*/
	case PHYDM_H2C:
		phydm_h2C_debugx(dm, input, &used, output, &out_len);
		break;

	case PHYDM_EXT_RF_E_CTRL:
		phydm_ext_rf_element_ctrlx(dm, input, &used, output, &out_len);
		break;
	...
	case PHYDM_PSD:
		...
		phydm_psdx_debug(dm, input, &used, output, &out_len);
		#endif

		break;

	case PHYDM_DEBUG_PORT:
		phydm_print_dbgportx(dm, input, &used, output, &out_len);
		break;
	...
	case PHYDM_CFO_TRK:
		phydm_cfo_trackingx_debug(dm, input, &used, output, &out_len);
		break;

	case PHYDM_ADAPTIVITY_DEBUG:
		#ifdef PHYDM_SUPPORT_ADAPTIVITY
		phydm_adaptivityx_debug(dm, input, &used, output, &out_len);
		#endif
		break;
	...
	case PHYDM_STA_INFO:
		phydm_show_sta_infox(dm, input, &used, output, &out_len);
		break;

	case PHYDM_PAUSE_FUNC:
		phydm_pause_funcx_console(dm, input, &used, output, &out_len);
		break;

	case PHYDM_PER_TONE_EVM:
		phydm_per_tone_evmx(dm, input, &used, output, &out_len);
		break;
	      ...
	      char *output, u32 out_len)
{
	...
	phydm_cmdx_parser(dm, argv, argc, flag, output, out_len);
		...
		if (dbg_num == 0) {
			...
			if (content_0 == 1)
				...
				PHYDM_DBG(dm, DBG_FW_TRACE,
					  ...
					  content_1, content_2, content_3,
					  content_4);
				phydm_print_ratex(dm, (u8)content_4,
						 DBG_FW_TRACE);
			} else if (content_0 == 3)
				PHYDM_DBG(dm, DBG_FW_TRACE,
					  "[FW] penality_idx=(( %d ))\n",
...
void phydm_fw_trace_handlerx_8051(void *dm_void, u8 *buffer, u8 cmd_len)
{
#ifdef CONFIG_PHYDM_DEBUG_FUNCTION
	struct dm_struct *dm = (struct dm_struct *)dm_void;
#if 0
