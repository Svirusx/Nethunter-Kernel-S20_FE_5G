...
)
{
	...
	if (dm->support_ic_type == ODM_RTL8192F) {
		regc80 = odm_get_bb_regx(dm, R_0xc80, MASKDWORD);
		regc88 = odm_get_bb_regx(dm, R_0xc88, MASKDWORD);
		regab4 = odm_get_bb_regx(dm, R_0xab4, MASKDWORD);
		rege14 = odm_get_bb_regx(dm, R_0xe14, MASKDWORD);
		reg848 = odm_get_bb_regx(dm, R_0x848, MASKDWORD);
		reg838 = odm_get_bb_regx(dm, R_0x838, MASKDWORD);
		reg86c = odm_get_bb_regx(dm, R_0x86c, MASKDWORD);
