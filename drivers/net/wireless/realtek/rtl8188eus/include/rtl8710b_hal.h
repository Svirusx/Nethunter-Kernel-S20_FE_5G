...
u8 SetHwRegx8710B(PADAPTER padapter, u8 variable, u8 *val);
void GetHwRegx8710B(PADAPTER padapter, u8 variable, u8 *val);
u8 SetHalDefVarx8710B(PADAPTER padapter, HAL_DEF_VARIABLE variable, void *pval);
u8 GetHalDefVarx8710B(PADAPTER padapter, HAL_DEF_VARIABLE variable, void *pval);
...
u8 MRateToHwRatex8710B(u8 rate);
