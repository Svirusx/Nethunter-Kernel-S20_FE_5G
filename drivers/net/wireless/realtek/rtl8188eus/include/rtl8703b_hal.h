...
u8 SetHwRegx8703B(PADAPTER padapter, u8 variable, u8 *val);
void GetHwRegx8703B(PADAPTER padapter, u8 variable, u8 *val);
u8 SetHalDefVarx8703B(PADAPTER padapter, HAL_DEF_VARIABLE variable, void *pval);
u8 GetHalDefVarx8703B(PADAPTER padapter, HAL_DEF_VARIABLE variable, void *pval);
...
u8 MRateToHwRatex8703B(u8  rate);
