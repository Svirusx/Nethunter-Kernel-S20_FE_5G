...
u8 SetHwRegx8188F(PADAPTER padapter, u8 variable, u8 *val);
void GetHwRegx8188F(PADAPTER padapter, u8 variable, u8 *val);
u8 SetHalDefVarx8188F(PADAPTER padapter, HAL_DEF_VARIABLE variable, void *pval);
u8 GetHalDefVarx8188F(PADAPTER padapter, HAL_DEF_VARIABLE variable, void *pval);
...
u8 MRateToHwRatex8188F(u8  rate);
