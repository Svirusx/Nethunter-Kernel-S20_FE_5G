...
extern int rtw_cfgvendor_attachbu(struct wiphy *wiphy);
extern int rtw_cfgvendor_detachbu(struct wiphy *wiphy);
extern int rtw_cfgvendor_send_async_eventbu(struct wiphy *wiphy,
