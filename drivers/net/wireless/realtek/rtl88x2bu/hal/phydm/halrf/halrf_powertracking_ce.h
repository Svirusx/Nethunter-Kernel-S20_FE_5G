...
#if (DM_ODM_SUPPORT_TYPE == ODM_CE) && defined(DM_ODM_CE_MAC80211)
#else
extern u8 delta_swing_table_idx_2ga_p_8188ebu[];
extern u8 delta_swing_table_idx_2ga_n_8188ebu[];
#endif
...
void odm_txpowertracking_direct_cebu(void *dm_void);

#if (DM_ODM_SUPPORT_TYPE & (ODM_WIN))

void odm_txpowertracking_callback_thermal_meterbu92c(
	void *adapter);

void odm_txpowertracking_callback_rx_gain_thermal_meter92d(
	void *adapter);

void odm_txpowertracking_callback_thermal_meterbu92d(
	void *adapter);
