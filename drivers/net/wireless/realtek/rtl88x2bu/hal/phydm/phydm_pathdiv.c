	...
	u8 path)
{
	...
	odm_set_bb_regbu(dm, R_0x93c, BIT(18) | BIT(19), 3);
	...
	if (num_enable_path == 1) {
		...
		if (path == (BB_PATH_AB)) { /* @2-1 */
			...
			/* set for 1ss */
			odm_set_bb_regbu(dm, R_0x93c, BIT(25) | BIT(24), 0);
			odm_set_bb_regbu(dm, R_0x93c, BIT(27) | BIT(26), 1);
			/* set for 2ss */
			odm_set_bb_regbu(dm, R_0x940, BIT(9) | BIT(8), 0);
			odm_set_bb_regbu(dm, R_0x940, BIT(11) | BIT(10), 1);
		} else if (path == BB_PATH_AC) { /* @2-2 */
			PHYDM_DBG(dm, DBG_PATH_DIV,
				  " Turn on path (( A C ))\n");
			/* set for 1ss */
			odm_set_bb_regbu(dm, R_0x93c, BIT(25) | BIT(24), 0);
			odm_set_bb_regbu(dm, R_0x93c, BIT(29) | BIT(28), 1);
			/* set for 2ss */
			odm_set_bb_regbu(dm, R_0x940, BIT(9) | BIT(8), 0);
			odm_set_bb_regbu(dm, R_0x940, BIT(13) | BIT(12), 1);
		} else if (path == BB_PATH_AD) { /* @2-3 */
			PHYDM_DBG(dm, DBG_PATH_DIV,
				  " Turn on path (( A D ))\n");
			/* set for 1ss */
			odm_set_bb_regbu(dm, R_0x93c, BIT(25) | BIT(24), 0);
			odm_set_bb_regbu(dm, R_0x93c, BIT(31) | BIT(30), 1);
			/* set for 2ss */
			odm_set_bb_regbu(dm, R_0x940, BIT(9) | BIT(8), 0);
			odm_set_bb_regbu(dm, R_0x940, BIT(15) | BIT(14), 1);
			...
			odm_set_bb_regbu(dm, R_0x93c, BIT(29) | BIT(28), 1);
			/* set for 2ss */
			odm_set_bb_regbu(dm, R_0x940, BIT(11) | BIT(10), 0);
			odm_set_bb_regbu(dm, R_0x940, BIT(13) | BIT(12), 1);
			...
			odm_set_bb_regbu(dm, R_0x93c, BIT(31) | BIT(30), 1);
			/* set for 2ss */
			odm_set_bb_regbu(dm, R_0x940, BIT(13) | BIT(12), 0);
			odm_set_bb_regbu(dm, R_0x940, BIT(15) | BIT(14), 1);
		}
		...
		odm_set_bb_regbu(dm, R_0x93c, 0xf00000, path);
		odm_set_bb_regbu(dm, R_0x940, 0xf0, path);
		odm_set_bb_regbu(dm, R_0x940, 0xf0000, path);
		...
		if (path == BB_PATH_ABC) { /* @3-1 */
			...
			odm_set_bb_regbu(dm, R_0x93c, BIT(25) | BIT(24), 0);
			odm_set_bb_regbu(dm, R_0x93c, BIT(27) | BIT(26), 1);
			odm_set_bb_regbu(dm, R_0x93c, BIT(29) | BIT(28), 2);
			/* set for 2ss */
			odm_set_bb_regbu(dm, R_0x940, BIT(9) | BIT(8), 0);
			odm_set_bb_regbu(dm, R_0x940, BIT(11) | BIT(10), 1);
			odm_set_bb_regbu(dm, R_0x940, BIT(13) | BIT(12), 2);
			/* set for 3ss */
			odm_set_bb_regbu(dm, R_0x940, BIT(21) | BIT(20), 0);
			odm_set_bb_regbu(dm, R_0x940, BIT(23) | BIT(22), 1);
			odm_set_bb_regbu(dm, R_0x940, BIT(25) | BIT(24), 2);
			...
			odm_set_bb_regbu(dm, R_0x93c, BIT(25) | BIT(24), 0);
			odm_set_bb_regbu(dm, R_0x93c, BIT(27) | BIT(26), 1);
			odm_set_bb_regbu(dm, R_0x93c, BIT(31) | BIT(30), 2);
			/* set for 2ss */
			odm_set_bb_regbu(dm, R_0x940, BIT(9) | BIT(8), 0);
			odm_set_bb_regbu(dm, R_0x940, BIT(11) | BIT(10), 1);
			odm_set_bb_regbu(dm, R_0x940, BIT(15) | BIT(14), 2);
			/* set for 3ss */
			odm_set_bb_regbu(dm, R_0x940, BIT(21) | BIT(20), 0);
			odm_set_bb_regbu(dm, R_0x940, BIT(23) | BIT(22), 1);
			odm_set_bb_regbu(dm, R_0x940, BIT(27) | BIT(26), 2);
			...
			/* set for 3ss */
			odm_set_bb_regbu(dm, R_0x940, BIT(21) | BIT(20), 0);
			odm_set_bb_regbu(dm, R_0x940, BIT(25) | BIT(24), 1);
			odm_set_bb_regbu(dm, R_0x940, BIT(27) | BIT(26), 2);
			...
			odm_set_bb_regbu(dm, R_0x940, BIT(15) | BIT(14), 2);
			/* set for 3ss */
			odm_set_bb_regbu(dm, R_0x940, BIT(23) | BIT(22), 0);
			odm_set_bb_regbu(dm, R_0x940, BIT(25) | BIT(24), 1);
			odm_set_bb_regbu(dm, R_0x940, BIT(27) | BIT(26), 2);
		}
...
/* @2 [Check Bfer] */
	...
	if (p_div->num_candidate == 1) {
		...
		odm_fill_h2c_cmdbu(dm, PHYDM_H2C_DYNAMIC_TX_PATH, 6, h2c_parameter);
	}
}
...
void phydm_update_tx_path_8812a(void *dm_void, enum bb_path path)
{
	...
	if (p_div->default_tx_path != path) {
		...
		if (path == BB_PATH_A) {
			/*Tx by Reg*/
			odm_set_bb_regbu(dm, R_0x80c, 0xFFF0, 0x111);
			/*Resp Tx by Txinfo*/
			odm_set_bb_regbu(dm, R_0x6d8, 0xc0, 1);
		} else {
			/*Tx by Reg*/
			odm_set_bb_regbu(dm, R_0x80c, 0xFFF0, 0x222);
			 /*Resp Tx by Txinfo*/
			odm_set_bb_regbu(dm, R_0x6d8, 0xc0, 2);
		}
	}
...
void phydm_path_diversity_init_8812a(void *dm_void)
{
	...
	odm_set_bb_regbu(dm, R_0x80c, BIT(29), 1); /* Tx path from Reg */
	odm_set_bb_regbu(dm, R_0x80c, 0xFFF0, 0x111); /* Tx by Reg */
	odm_set_bb_regbu(dm, R_0x6d8, BIT(7) | BIT6, 1); /* Resp Tx by Txinfo */
				       ...
				       enum bb_path path, boolean enable)
{
	...
	odm_fill_h2c_cmdbu(dm, PHYDM_H2C_DYNAMIC_TX_PATH, 7, h2c_para);
}
...
void phydm_tx_path_by_mac_or_reg(void *dm_void, enum phydm_path_ctrl ctrl)
{
	...
	case ODM_RTL8197G:
		if (ctrl == TX_PATH_BY_REG) {
			odm_set_bb_regbu(dm, R_0x1e24, BIT(16), 0); /*OFDM*/
			odm_set_bb_regbu(dm, R_0x1a84, 0xe0, 0); /*CCK*/
		} else {
			odm_set_bb_regbu(dm, R_0x1e24, BIT(16), 1); /*OFDM*/
			odm_set_bb_regbu(dm, R_0x1a84, 0xe0, 7); /*CCK*/
		}
	...
	case ODM_RTL8822B:
		if (ctrl == TX_PATH_BY_REG) {
			odm_set_bb_regbu(dm, R_0x93c, BIT(18), 0);
			odm_set_bb_regbu(dm, R_0xa84, 0xe0, 0); /*CCK*/
		} else {
			odm_set_bb_regbu(dm, R_0x93c, BIT(18), 1);
			odm_set_bb_regbu(dm, R_0xa84, 0xe0, 7); /*CCK*/
		}
