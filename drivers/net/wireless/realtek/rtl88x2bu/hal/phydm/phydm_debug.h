...
void phydm_basic_profilebu(void *dm_void, u32 *_used, char *output,
			 u32 *_out_len);
#if (DM_ODM_SUPPORT_TYPE & (ODM_CE | ODM_AP))
s32 phydm_cmdbu(struct dm_struct *dm, char *input, u32 in_len, u8 flag,
	      char *output, u32 out_len);
#endif
void phydm_cmdbu_parserbu(struct dm_struct *dm, char input[][16], u32 input_num,
...
void phydm_fw_trace_handlerbu_8051(void *dm_void, u8 *cmd_buf, u8 cmd_len);
