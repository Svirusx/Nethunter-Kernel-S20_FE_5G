...
void phydm_igi_toggle_8822b(struct dm_struct *dm)
{
	...
	igi = odm_get_bb_regbu(dm, R_0xc50, 0x7f);
	odm_set_bb_regbu(dm, R_0xc50, 0x7f, (igi - 2));
	odm_set_bb_regbu(dm, R_0xc50, 0x7f, igi);
	odm_set_bb_regbu(dm, R_0xe50, 0x7f, (igi - 2));
	odm_set_bb_regbu(dm, R_0xe50, 0x7f, igi);
}
...
void phydm_8822b_type18_rfe(struct dm_struct *dm, u8 channel)
{
	if (channel <= 14) {
		/* signal source */
		odm_set_bb_regbu(dm, R_0xcb0, 0xffffff, 0x745774);
		odm_set_bb_regbu(dm, R_0xeb0, 0xffffff, 0x745774);
		odm_set_bb_regbu(dm, R_0xcb4, MASKBYTE1, 0x57);
		odm_set_bb_regbu(dm, R_0xeb4, MASKBYTE1, 0x57);
	} else if ((channel > 35) && (channel <= 64)) {
		/* signal source */
		odm_set_bb_regbu(dm, R_0xcb0, 0xffffff, 0x177517);
		odm_set_bb_regbu(dm, R_0xeb0, 0xffffff, 0x177517);
		odm_set_bb_regbu(dm, R_0xcb4, MASKLWORD, 0x7577);
		odm_set_bb_regbu(dm, R_0xeb4, MASKLWORD, 0x7577);
		odm_set_bb_regbu(dm, R_0xcb8, BIT(5), 0);
		odm_set_bb_regbu(dm, R_0xeb8, BIT(5), 0);
	} else if (channel > 64) {
		/* signal source */
		odm_set_bb_regbu(dm, R_0xcb0, 0xffffff, 0x177517);
		odm_set_bb_regbu(dm, R_0xeb0, 0xffffff, 0x177517);
	...
	/* invertor and antenna switch */
		if (channel <= 14) {
			/* inverse or not */
			odm_set_bb_regbu(dm, R_0xcbc, 0x3f, 0x8);
			odm_set_bb_regbu(dm, R_0xcbc, (BIT(11) | BIT(10)), 0x2);
			odm_set_bb_regbu(dm, R_0xebc, 0x3f, 0x8);
			odm_set_bb_regbu(dm, R_0xebc, (BIT(11) | BIT(10)), 0x2);

			/* antenna switch table */
			if (dm->rx_ant_status == BB_PATH_AB ||
			    dm->tx_ant_status == BB_PATH_AB) {
				/* 2TX or 2RX */
				odm_set_bb_regbu(dm, R_0xca0, MASKLWORD, 0xf050);
				odm_set_bb_regbu(dm, R_0xea0, MASKLWORD, 0xf050);
			} else if (dm->rx_ant_status == dm->tx_ant_status) {
				/* TXA+RXA or TXB+RXB */
				odm_set_bb_regbu(dm, R_0xca0, MASKLWORD, 0xf055);
				odm_set_bb_regbu(dm, R_0xea0, MASKLWORD, 0xf055);
			} else {
				/* TXB+RXA or TXA+RXB */
				odm_set_bb_regbu(dm, R_0xca0, MASKLWORD, 0xf550);
				odm_set_bb_regbu(dm, R_0xea0, MASKLWORD, 0xf550);
			}

		} else if (channel > 35) {
			/* inverse or not */
			odm_set_bb_regbu(dm, R_0xcbc, 0x3f, 0x0);
			odm_set_bb_regbu(dm, R_0xcbc, (BIT(11) | BIT(10) | BIT(9)
					| BIT(8)), 0x0);
			odm_set_bb_regbu(dm, R_0xebc, 0x3f, 0x0);
			odm_set_bb_regbu(dm, R_0xebc, (BIT(11) | BIT(10) | BIT(9)
					| BIT(8)), 0x0);

			if (channel <= 64)
				odm_set_bb_regbu(dm, 0xcbc, BIT(9), 0x1);
			else
				odm_set_bb_regbu(dm, 0xcbc, BIT(8), 0x1);

			/* delay 400ns for PAPE */
			/* odm_set_bb_regbu(p_dm, 0x810, MASKBYTE3|BIT20|BIT21*/
			/* |BIT22|BIT23, 0x211); */
			...
			if (dm->rx_ant_status == BB_PATH_AB ||
			    dm->tx_ant_status == BB_PATH_AB) {
				/* 2TX or 2RX */
				odm_set_bb_regbu(dm, R_0xca0, MASKLWORD, 0x0501);
				odm_set_bb_regbu(dm, R_0xea0, MASKLWORD, 0x0501);
			} else if (dm->rx_ant_status == dm->tx_ant_status) {
				/* TXA+RXA or TXB+RXB */
				odm_set_bb_regbu(dm, R_0xca0, MASKLWORD, 0xa500);
				odm_set_bb_regbu(dm, R_0xea0, MASKLWORD, 0xa500);
			} else {
				/* TXB+RXA or TXA+RXB */
				odm_set_bb_regbu(dm, R_0xca0, MASKLWORD, 0xa005);
				odm_set_bb_regbu(dm, R_0xea0, MASKLWORD, 0xa005);
			}
		}
}
...
void phydm_8822b_type15_rfe(struct dm_struct *dm, u8 channel)
{
	if (channel <= 14) {
		/* signal source */
		odm_set_bb_regbu(dm, R_0xcb0, 0xffffff, 0x777777);
		odm_set_bb_regbu(dm, R_0xeb0, 0xffffff, 0x777777);
		odm_set_bb_regbu(dm, R_0xcb4, MASKBYTE1, 0x77);
		odm_set_bb_regbu(dm, R_0xeb4, MASKBYTE1, 0x77);

	} else if ((channel > 35) && (channel <= 64)) {
		/* signal source */
		odm_set_bb_regbu(dm, R_0xcb0, 0xffffff, 0x777747);
		odm_set_bb_regbu(dm, R_0xeb0, 0xffffff, 0x777747);
		odm_set_bb_regbu(dm, R_0xcb4, MASKBYTE0, 0x57);
		odm_set_bb_regbu(dm, R_0xeb4, MASKBYTE0, 0x57);

	} else if (channel > 64) {
		/* signal source */
		odm_set_bb_regbu(dm, R_0xcb0, 0xffffff, 0x777747);
		odm_set_bb_regbu(dm, R_0xeb0, 0xffffff, 0x777747);
		odm_set_bb_regbu(dm, R_0xcb4, MASKBYTE0, 0x75);
		odm_set_bb_regbu(dm, R_0xeb4, MASKBYTE0, 0x75);
	...
	/* @inverse or not */
	odm_set_bb_regbu(dm, R_0xcbc, 0x3f, 0x0);
	odm_set_bb_regbu(dm, R_0xcbc, BIT(11) | BIT(10) | BIT(9) | BIT(8), 0x0);
	odm_set_bb_regbu(dm, R_0xebc, 0x3f, 0x0);
	odm_set_bb_regbu(dm, R_0xebc, BIT(11) | BIT(10) | BIT(9) | BIT(8), 0x0);
	...
	if (channel <= 14) {
		if (dm->rx_ant_status == BB_PATH_AB ||
		    dm->tx_ant_status == BB_PATH_AB) {
			/* @2TX or 2RX */
			odm_set_bb_regbu(dm, R_0xca0, MASKLWORD, 0xa501);
			odm_set_bb_regbu(dm, R_0xea0, MASKLWORD, 0xa501);
		} else if (dm->rx_ant_status == dm->tx_ant_status) {
			/* TXA+RXA or TXB+RXB */
			odm_set_bb_regbu(dm, R_0xca0, MASKLWORD, 0xa500);
			odm_set_bb_regbu(dm, R_0xea0, MASKLWORD, 0xa500);
		...
		odm_set_bb_regbu(dm, R_0xca0, MASKLWORD, 0xa5a5);
		odm_set_bb_regbu(dm, R_0xea0, MASKLWORD, 0xa5a5);
	}
}
			     ...
			     u8 inv_en, u8 source_sel)
{
	...
	/*@[Path_mux_sel]*/
	odm_set_bb_regbu(dm, R_0x1990, BIT(rfe_n),
		       ((mux_sel == BB_PATH_A) ? 0 : 1));

	/*@[Inv_en]*/
	odm_set_bb_regbu(dm, R_0xcbc, BIT(rfe_n), (u32)inv_en);
	odm_set_bb_regbu(dm, R_0xebc, BIT(rfe_n), (u32)inv_en);

	/*@[Output Source Signal Selection]*/
	if (rfe_n <= 7) {
		odm_set_bb_regbu(dm, R_0xcb0, ((0xf) << (rfe_n * 4)),
			       (u32)source_sel);
		odm_set_bb_regbu(dm, R_0xeb0, ((0xf) << (rfe_n * 4)),
			       (u32)source_sel);
	} else {
		odm_set_bb_regbu(dm, R_0xcb4, ((0xf) << ((rfe_n - 8) * 4)),
			       (u32)source_sel);
		odm_set_bb_regbu(dm, R_0xeb4, ((0xf) << ((rfe_n - 8) * 4)),
			       (u32)source_sel);
	}
}
...
void phydm_rfe_8822b_init(struct dm_struct *dm)
{
	...
	/* @chip top mux */
	odm_set_bb_regbu(dm, R_0x64, BIT(29) | BIT(28), 0x3);
	odm_set_bb_regbu(dm, R_0x4c, BIT(26) | BIT(25), 0x0);
	odm_set_bb_regbu(dm, R_0x40, BIT(2), 0x1);

	/* @from s0 or s1 */
	odm_set_bb_regbu(dm, R_0x1990, 0x3f, 0x30);
	odm_set_bb_regbu(dm, R_0x1990, (BIT(11) | BIT(10)), 0x3);

	/* @input or output */
	odm_set_bb_regbu(dm, R_0x974, 0x3f, 0x3f);
	odm_set_bb_regbu(dm, R_0x974, (BIT(11) | BIT(10)), 0x3);
}
...
void phydm_rfe_4_11(struct dm_struct *dm, u8 channel)
{
...
#if 0
	/*odm_set_bb_regbu(dm, R_0x804, (BIT(1)|BIT(0)), 0x0);*/
#endif
	...
	if (is_channel_2g) {
		...
		/* signal source */
		odm_set_bb_regbu(dm, R_0xcb0, 0xffffff, 0x477547);
		odm_set_bb_regbu(dm, R_0xeb0, 0xffffff, 0x477547);
		odm_set_bb_regbu(dm, R_0xcb4, MASKBYTE1, 0x75);
		odm_set_bb_regbu(dm, R_0xeb4, MASKBYTE1, 0x75);

		/* @inverse or not */
		odm_set_bb_regbu(dm, R_0xcbc, 0x3f, 0x0);
		odm_set_bb_regbu(dm, R_0xcbc, (BIT(11) | BIT(10)), 0x0);
		odm_set_bb_regbu(dm, R_0xebc, 0x3f, 0x0);
		odm_set_bb_regbu(dm, R_0xebc, (BIT(11) | BIT(10)), 0x0);
...
void phydm_rfe_efem(struct dm_struct *dm, u8 channel)
{
	...
	if (dm->cut_version == ODM_CUT_B && rfe_type < 2) {
		if (is_channel_2g) {
		/* signal source */
			odm_set_bb_regbu(dm, R_0xcb0, 0xffffff, 0x704570);
			odm_set_bb_regbu(dm, R_0xeb0, 0xffffff, 0x704570);
			odm_set_bb_regbu(dm, R_0xcb4, MASKBYTE1, 0x45);
			odm_set_bb_regbu(dm, R_0xeb4, MASKBYTE1, 0x45);
		} else {
			odm_set_bb_regbu(dm, R_0xcb0, 0xffffff, 0x174517);
			odm_set_bb_regbu(dm, R_0xeb0, 0xffffff, 0x174517);
			odm_set_bb_regbu(dm, R_0xcb4, MASKBYTE1, 0x45);
			odm_set_bb_regbu(dm, R_0xeb4, MASKBYTE1, 0x45);
		}

		/* @delay 400ns for PAPE */
		odm_set_bb_regbu(dm, R_0x810, 0xfff00000, 0x211);

		/* @antenna switch table */
		odm_set_bb_regbu(dm, R_0xca0, MASKLWORD, 0xa555);
		odm_set_bb_regbu(dm, R_0xea0, MASKLWORD, 0xa555);
		...
		if (is_channel_2g) {
		/* signal source */
			odm_set_bb_regbu(dm, R_0xcb0, 0xffffff, 0x705770);
			odm_set_bb_regbu(dm, R_0xeb0, 0xffffff, 0x705770);
			odm_set_bb_regbu(dm, R_0xcb4, MASKBYTE1, 0x57);
			odm_set_bb_regbu(dm, R_0xeb4, MASKBYTE1, 0x57);
			odm_set_bb_regbu(dm, R_0xcb8, BIT(4), 0);
			odm_set_bb_regbu(dm, R_0xeb8, BIT(4), 0);
		} else {
		/* signal source */
			odm_set_bb_regbu(dm, R_0xcb0, 0xffffff, 0x177517);
			odm_set_bb_regbu(dm, R_0xeb0, 0xffffff, 0x177517);
		...
		/* @delay 400ns for PAPE */
		/* odm_set_bb_regbu(dm, R_0x810, MASKBYTE3|BIT20|BIT21|BIT22|*/
					/*@BIT23, 0x211); */
...
#if 0
	/* @[MAC] */
	odm_set_mac_regbu(dm, R_0x4c, BIT(23), 0);/* path-A, RFE_CTRL_8 */
	odm_set_mac_regbu(dm, R_0x4c, BIT(24), 1);/* path-A, RFE_CTRL_9 */
	/* @[BB] */
	odm_set_bb_regbu(dm, R_0x970, BIT(9) | BIT(8), 0x3);/* RFE_buffer */
	odm_set_bb_regbu(dm, R_0x1990, BIT(8), 0x0);
	/* r_rfe_path_sel_   (RFE_CTRL_8) */
	odm_set_bb_regbu(dm, R_0x1990, BIT(9), 0x0);
	/* r_rfe_path_sel_   (RFE_CTRL_9) */
	odm_set_bb_regbu(dm, R_0xcbc, BIT(19), 0x0);/* RFE_buffer */
	odm_set_bb_regbu(dm, R_0xcbc, BIT(8), 0x0);/* rfe_inv  (RFE_CTRL_8) */
	odm_set_bb_regbu(dm, R_0xcbc, BIT(9), 0x1);/* rfe_inv  (RFE_CTRL_9) */
	odm_set_bb_regbu(dm, R_0xcb4, 0xF, 0x8);/* path-A, RFE_CTRL_8 */
	odm_set_bb_regbu(dm, R_0xcb4, 0xF0, 0x8);/* path-A, RFE_CTRL_9 */
#endif
	odm_set_mac_regbu(dm, R_0x40, BIT(2), 1);
	odm_set_bb_regbu(dm, R_0x970, BIT(5), 1); /* RFE_buffer */
	odm_set_bb_regbu(dm, R_0x970, BIT(10), 1); /* RFE_buffer */
	odm_set_bb_regbu(dm, R_0x1990, BIT(5), 0x0);
	/*@r_rfe_path_sel_	(RFE_CTRL_5) */
	odm_set_bb_regbu(dm, R_0x1990, BIT(10), 0x0);
	/*@r_rfe_path_sel_	 (RFE_CTRL_10) */
	odm_set_bb_regbu(dm, R_0xcbc, BIT(19), 0x0); /* RFE_buffer */
	odm_set_bb_regbu(dm, R_0xcbc, BIT(5), 0x0); /* rfe_inv  (RFE_CTRL_5) */
	odm_set_bb_regbu(dm, R_0xcbc, BIT(10), 0x1); /* rfe_inv  (RFE_CTRL_10) */
	odm_set_bb_regbu(dm, R_0xcb0, 0xF00000, 0x8); /* path-A, RFE_CTRL_5 */
	odm_set_bb_regbu(dm, R_0xcb4, 0xF00, 0x8); /* path-A, RFE_CTRL_10 */
}
...
void phydm_rfe_2t4r(struct dm_struct *dm, u8 channel)
{
	...
	odm_set_bb_regbu(dm, R_0x1990, BIT(5), 0x0);
	/*@r_rfe_path_sel_   (RFE_CTRL_5) */
	odm_set_bb_regbu(dm, R_0x1990, BIT(10), 0x1);
	/*@r_rfe_path_sel_ Path B   (RFE_CTRL_10) */
	odm_set_bb_regbu(dm, R_0xcbc, BIT(19), 0x0); /* RFE_buffer */
	odm_set_bb_regbu(dm, R_0xebc, BIT(19), 0x0); /* RFE_buffer */
	odm_set_bb_regbu(dm, R_0xcbc, BIT(5), 0x0); /* rfe_inv  (RFE_CTRL_5) */
	odm_set_bb_regbu(dm, R_0xebc, BIT(10), 0x0); /* rfe_inv  (RFE_CTRL_10) */
	odm_set_bb_regbu(dm, R_0xcb0, 0xF00000, 0x8); /* path-A, RFE_CTRL_5 */
	odm_set_bb_regbu(dm, R_0xeb4, 0xF00, 0x8); /* path-B, RFE_CTRL_10 */
}
...
#if 1
		/*path A*/
		odm_set_bb_regbu(dm, R_0x1990, BIT(3), 0); /*RFE_CTRL_3*/ /*A_0*/
		odm_set_bb_regbu(dm, R_0x1990, BIT(0), 0); /*RFE_CTRL_0*/ /*A_1*/
		odm_set_bb_regbu(dm, R_0x1990, BIT(8), 0); /*RFE_CTRL_8*/ /*A_2*/

		/*path B*/
		odm_set_bb_regbu(dm, R_0x1990, BIT(4), 1); /*RFE_CTRL_4*/ /*B_0*/
		odm_set_bb_regbu(dm, R_0x1990, BIT(11), 1); /*RFE_CTRL_11*//*B_1*/
		odm_set_bb_regbu(dm, R_0x1990, BIT(9), 1); /*RFE_CTRL_9*/ /*B_2*/

		odm_set_bb_regbu(dm, R_0xcb0, MASKDWORD, 0x77178519);
#if 0
		/* odm_set_bb_regbu(dm, R_0xeb0, MASKDWORD, 0x77177517); */
#endif
		odm_set_bb_regbu(dm, R_0xeb0, MASKDWORD, 0x771c7517);
		odm_set_bb_regbu(dm, R_0xcb4, MASKDWORD, 0x757a);
#if 0
		/* odm_set_bb_regbu(dm, R_0xeb4, MASKBYTE1, 0x7577); */
#endif
		odm_set_bb_regbu(dm, R_0xeb4, MASKDWORD, 0xd5e7);

		/* @inverse or not */
		odm_set_bb_regbu(dm, R_0xcbc, 0xfff, 0x0);
		odm_set_bb_regbu(dm, R_0xebc, 0xfff, 0x0);
#else
...
void phydm_ccapar_by_rfe_8822b(struct dm_struct *dm)
{
	...
	odm_move_memorybu(dm, cca_efem, cca_efem_ccut, 12 * 4);
	if (dm->rfe_type == 3 || dm->rfe_type == 5 ||
	    dm->rfe_type == 12 || dm->rfe_type == 15 ||
	    dm->rfe_type == 16 || dm->rfe_type == 17 ||
	    dm->rfe_type == 19) {
		odm_move_memorybu(dm, cca_ifem, cca_ifem_ccut_rfe, 12 * 4);
		is_rfe_type = true;
	} else {
		odm_move_memorybu(dm, cca_ifem, cca_ifem_ccut, 12 * 4);
	}
	...
	odm_set_bb_regbu(dm, R_0x82c, MASKDWORD, reg82c);
	...
	if (is_ifem_cca) {
		if ((dm->cut_version == ODM_CUT_B && (col == 1 || col == 3) &&
		    ...
		    (dm->rfe_type == 5 && col == 3))
			odm_set_bb_regbu(dm, R_0x830, MASKDWORD, 0x79a0ea28);
		else
			odm_set_bb_regbu(dm, R_0x830, MASKDWORD, reg830);
	} else {
		odm_set_bb_regbu(dm, R_0x830, MASKDWORD, reg830);
	}
	odm_set_bb_regbu(dm, R_0x838, MASKDWORD, reg838);

	if (is_efem_cca && !(dm->cut_version == ODM_CUT_B))
		odm_set_bb_regbu(dm, R_0x83c, MASKDWORD, 0x9194b2b9);
	/* @enlarge big jump size in type 16 for MS case */
	if (dm->rfe_type == 16 && central_ch_8822b <= 14)
		odm_set_bb_regbu(dm, R_0x8c8, BIT(3) | BIT(2) | BIT(1), 0x3);
	/* @CCA parameters adjust for 20MHz on DFS channel */
	if ((*dm->band_width == CHANNEL_WIDTH_20) &&
	    (((*dm->channel >= 52) && (*dm->channel <= 64)) ||
	     ((*dm->channel >= 100) && (*dm->channel <= 144))))
		odm_set_bb_regbu(dm, 0x838, 0xf0, 0x5);
				 ...
				 enum channel_width bandwidth)
{
	if (bandwidth == CHANNEL_WIDTH_40) {
		/* RX DFIR for BW40 */
		odm_set_bb_regbu(dm, R_0x948, BIT(29) | BIT(28), 0x1);
		odm_set_bb_regbu(dm, R_0x94c, BIT(29) | BIT(28), 0x0);
		odm_set_bb_regbu(dm, R_0xc20, BIT(31), 0x0);
		odm_set_bb_regbu(dm, R_0xe20, BIT(31), 0x0);
	} else if (bandwidth == CHANNEL_WIDTH_80) {
		/* RX DFIR for BW80 */
		odm_set_bb_regbu(dm, R_0x948, BIT(29) | BIT(28), 0x2);
		odm_set_bb_regbu(dm, R_0x94c, BIT(29) | BIT(28), 0x1);
		odm_set_bb_regbu(dm, R_0xc20, BIT(31), 0x0);
		odm_set_bb_regbu(dm, R_0xe20, BIT(31), 0x0);
	} else {
		/* RX DFIR for BW20, BW10 and BW5*/
		odm_set_bb_regbu(dm, R_0x948, BIT(29) | BIT(28), 0x2);
		odm_set_bb_regbu(dm, R_0x94c, BIT(29) | BIT(28), 0x2);
		odm_set_bb_regbu(dm, R_0xc20, BIT(31), 0x1);
		odm_set_bb_regbu(dm, R_0xe20, BIT(31), 0x1);
	}
#if 0
			      ...
			      u32 pw_idx, enum rf_path path, u8 hw_rate)
{
	...
	odm_set_bb_regbu(dm, (offset_txagc[path] + rate_idx), MASKDWORD,
		       txagc_idx);
...
void phydm_get_condi_num_acc_8822b(void *dm_void)
{
	...
	for (i = 0; i < CN_CNT_MAX; i++) {
		odm_set_bb_regbu(dm, R_0x1988, 0x3fff00, (i << 4));
		dbg->condi_num_cdf[i] = odm_read_1bytebu(dm, R_0xf87);
	}

#if 0
	/*@disable report condition number*/
	/*odm_set_bb_regbu(dm, R_0x1988, BIT(22), 0x0);*/
#endif
#endif
}
...
u32 phydm_get_condi_num_8822b(struct dm_struct *dm)
{
	...
	odm_set_bb_regbu(dm, R_0x1988, BIT(22), 0x1);

	/*@get condi_num_avg U(18,4)*/
	val = odm_get_bb_regbu(dm, R_0xf84, (BIT(17) | BIT(16) | MASKLWORD));
				   ...
				   u32 bit_mask)
{
	...
	readback_value = odm_get_bb_regbu(dm, direct_addr, bit_mask);
				...
				u32 data)
{
	...
	/* Write operation */
	odm_set_bb_regbu(dm, offset_write_rf[path], MASKDWORD, data_and_addr);
	PHYDM_DBG(dm, ODM_PHY_CONFIG,
			       ...
			       u32 pw_idx, enum rf_path path, u8 hw_rate)
{
	...
	odm_set_bb_regbu(dm, (offset_txagc[path] + rate_idx), MASKDWORD, pw_idx);
				 ...
				 enum rf_path path, u8 hw_rate)
{
	...
	odm_set_bb_regbu(dm, R_0x1998, BIT(16), 0x0); /* need to check */

	/* Set data rate index (bit0~6) and path index (bit7) */
	odm_set_bb_regbu(dm, R_0x1998, MASKBYTE0, (hw_rate | (path << 7)));

	/* @Enable TXAGC report */
	odm_set_bb_regbu(dm, R_0x1998, BIT(16), 0x1);

	/* Read TX AGC report */
	read_back_data = (u8)odm_get_bb_regbu(dm, R_0xd30, 0x7f0000);

	/* @Driver have to disable TXAGC report after reading TXAGC */
	/* @(ref. user guide v11) */
	odm_set_bb_regbu(dm, R_0x1998, BIT(16), 0x0);
...
void phydm_dsde_init(struct dm_struct *dm)
{
	...
	odm_set_bb_regbu(dm, R_0x874, BIT(0), 0x0);
}
...
void phydm_dsde_nbi(struct dm_struct *dm)
{
	...
	if (dm->rfe_type == 15 || dm->rfe_type == 16)
		odm_set_bb_regbu(dm, 0x82c, 0xff000, 0x86);
	else
		odm_set_bb_regbu(dm, 0x82c, 0xff000, 0x97);
	if (dm->rfe_type == 12 || dm->rfe_type == 19) {
		if (*dm->band_width == CHANNEL_WIDTH_20) {
			if (*dm->channel >= 5 && *dm->channel <= 7)
				odm_set_bb_regbu(dm, 0x82c, 0xf000, 0x3);
		}
	} else {
		odm_set_bb_regbu(dm, 0x82c, 0xf000, 0x7);
	}
	if (*dm->band_width == CHANNEL_WIDTH_20) {
		if (*dm->channel == 153)
			set_nbi = phydm_nbi_settingbu(dm, FUNC_ENABLE,
						    *dm->channel, 20, 5760,
						    PHYDM_DONT_CARE);
...
void phydm_dsde_csi(struct dm_struct *dm)
{
	...
	if (*dm->band_width == CHANNEL_WIDTH_20) {
		if (*dm->channel == 153)
			set_result_csi =
			phydm_csi_mask_settingbu(dm, FUNC_ENABLE, *dm->channel,
...
void phydm_dynamic_spur_det_eliminate(struct dm_struct *dm)
{
	...
	for (k = 0; k < PSD_SMP_NUM; k++) {
		...
		for (j = 0; j < PSD_VAL_NUM; j++) {
			...
			odm_set_bb_regbu(dm, R_0xc00, MASKBYTE0, 0x4);
			odm_set_bb_regbu(dm, R_0xe00, MASKBYTE0, 0x4);
			reg_910_15_12 = odm_get_bb_regbu(dm, R_0x910, (BIT(15) |
							BIT(14) | BIT(13) |
							BIT(12)));

			if (dm->rx_ant_status & BB_PATH_A) {
				odm_set_bb_regbu(dm, R_0x808, MASKBYTE0,
					       (((BB_PATH_A) << 4) |
					       BB_PATH_A)); /*path-A*/

				if ((*dm->channel >= 1) && (*dm->channel <= 14))
					/* Start PSD at 2G */
					odm_set_bb_regbu(dm, R_0x910, MASKDWORD,
						       BIT(22) | f_pt_2g);
				else
					/* Start PSD at 5G */
					odm_set_bb_regbu(dm, R_0x910, MASKDWORD,
				...
				psd_set[j] = odm_get_bb_regbu(dm, R_0xf44,
							    MASKLWORD);
				/* turn off PSD */
				odm_set_bb_regbu(dm, R_0x910, BIT(22), 0x0);
			}
			...
			if (dm->rx_ant_status & BB_PATH_B) {
				...
				psd_set_B[j] = odm_get_bb_regbu(dm, R_0xf44,
							      MASKLWORD);
			...
			/*@eanble 3-wire*/
			odm_set_bb_regbu(dm, R_0xc00, MASKBYTE0, 0x7);
			odm_set_bb_regbu(dm, R_0xe00, MASKBYTE0, 0x7);
			odm_set_bb_regbu(dm, R_0x910, (BIT(15) | BIT(14) |
		...
		if (dm->rx_ant_status & BB_PATH_A) {
			phydm_seq_sortingbu(dm, psd_set, rank_psd_index_in,
					  rank_psd_index_out, PSD_VAL_NUM);
			max_ret_psd_2nd[k] = psd_set[0];
		}
		if (dm->rx_ant_status & BB_PATH_B) {
			phydm_seq_sortingbu(dm, psd_set_B, rank_psd_index_in,
					  rank_psd_index_out, PSD_VAL_NUM);
	...
	if (dm->rx_ant_status & BB_PATH_A) {
		phydm_seq_sortingbu(dm, max_ret_psd_2nd, rank_sample_index_in,
	...
	if (dm->rx_ant_status & BB_PATH_B) {
		phydm_seq_sortingbu(dm, max_ret_psd_b_2nd, rank_sample_index_in,
				  rank_sample_index_out, PSD_SMP_NUM);
...
void phydm_spur_calibration_8822b(struct dm_struct *dm)
{
	...
	odm_set_bb_regbu(dm, R_0x87c, BIT(13), 0x0);
	odm_set_bb_regbu(dm, R_0xc20, BIT(28), 0x0);
	odm_set_bb_regbu(dm, R_0xe20, BIT(28), 0x0);
			       ...
			       u8 central_ch)
{
	...
	if (central_ch <= 14) {
		...
		/* @Enable CCK block */
		odm_set_bb_regbu(dm, R_0x808, BIT(28), 0x1);

		/* @Disable MAC CCK check */
		odm_set_bb_regbu(dm, R_0x454, BIT(7), 0x0);

		/* @Disable BB CCK check */
		odm_set_bb_regbu(dm, R_0xa80, BIT(18), 0x0);

		/*@CCA Mask*/
		odm_set_bb_regbu(dm, R_0x814, 0x0000FC00, 15); /*@default value*/
		...
		reg_8 = odm_get_bb_regbu(dm, R_0x19a8, BIT(31));

		/* SoML on */
		if (reg_8 == 0x1) {
			odm_set_bb_regbu(dm, R_0xc04, (BIT(18) | BIT(21)), 0x0);
			odm_set_bb_regbu(dm, R_0xe04, (BIT(18) | BIT(21)), 0x0);
			if (dm->rfe_type == 3 || dm->rfe_type == 5 ||
			    dm->rfe_type == 8 || dm->rfe_type == 17) {
				odm_set_bb_regbu(dm, R_0x8cc, MASKDWORD,
					       0x08108492);
				odm_set_bb_regbu(dm, R_0x8d8, BIT(19), 0x0);
				odm_set_bb_regbu(dm, R_0x8d8, BIT(27), 0x1);
			} else {
				odm_set_bb_regbu(dm, R_0x8cc, MASKDWORD,
					       0x08108000);
				odm_set_bb_regbu(dm, R_0x8d8, BIT(19), 0x0);
				odm_set_bb_regbu(dm, R_0x8d8, BIT(27), 0x0);
			}
		}
		...
		if (dm->rfe_type == 12 || dm->rfe_type == 19) {
			odm_set_rf_regbu(dm, RF_PATH_A, RF_0xb3, RFREGOFFSETMASK,
				       0x3C360);
			odm_set_rf_regbu(dm, RF_PATH_B, RF_0xb3, RFREGOFFSETMASK,
				       0x3C360);
		}
		...
		/* @Enable BB CCK check */
		odm_set_bb_regbu(dm, R_0xa80, BIT(18), 0x1);

		/* @Enable CCK check */
		odm_set_bb_regbu(dm, R_0x454, BIT(7), 0x1);

		/* @Disable CCK block */
		odm_set_bb_regbu(dm, R_0x808, BIT(28), 0x0);

/*@CCA Mask*/
#if (DM_ODM_SUPPORT_TYPE == ODM_AP)
		/*@CCA mask = 13.6us*/
		odm_set_bb_regbu(dm, R_0x814, 0x0000FC00, 34);
#else
		if (!dm->wifi_test)
			/*@CCA mask = 13.6us*/
			odm_set_bb_regbu(dm, R_0x814, 0x0000FC00, 34);
			...
			/*@default value = 6us*/
			odm_set_bb_regbu(dm, R_0x814, 0x0000FC00, 15);
#endif
		...
		if (reg_8 == 0x1) {
			odm_set_bb_regbu(dm, R_0xc04, (BIT(18) | BIT(21)), 0x0);
			odm_set_bb_regbu(dm, R_0xe04, (BIT(18) | BIT(21)), 0x0);
			odm_set_bb_regbu(dm, R_0x8cc, MASKDWORD, 0x08108000);
			odm_set_bb_regbu(dm, R_0x8d8, BIT(27), 0x0);
		}
	...
	odm_set_rf_regbu(dm, RF_PATH_A, RF_0x18, RFREGOFFSETMASK, rf_reg18);

	if (dm->rf_type > RF_1T1R)
		odm_set_rf_regbu(dm, RF_PATH_B, RF_0x18, RFREGOFFSETMASK,
			       rf_reg18);
			      ...
			      boolean enable_rxagc_switch)
{
	...
	if (enable_rxagc_switch) {
		if ((*dm->channel >= 36) && (*dm->channel <= 64)) {
			odm_set_bb_regbu(dm, R_0x958, BIT(4), 0x1);
			odm_set_bb_regbu(dm, R_0xc1c, (BIT(11) | BIT(10) |
				       BIT(9) | BIT(8)), 0x1);
			odm_set_bb_regbu(dm, R_0xe1c, (BIT(11) | BIT(10) |
				       BIT(9) | BIT(8)), 0x5);
				  ...
				  u8 central_ch)
{
	...
	if (central_ch <= 14) {
		...
		odm_set_bb_regbu(dm, R_0x958, 0x1f, 0x0);
		dig_tab->agc_table_idx = 0x0;

		/* @3. Set central frequency for clock offset tracking */
		odm_set_bb_regbu(dm, R_0x860, 0x1ffe0000, 0x96a);

		/* @CCK TX filter parameters */

		if (central_ch == 14) {
			odm_set_bb_regbu(dm, R_0xa24, MASKDWORD, 0x00006577);
			odm_set_bb_regbu(dm, R_0xa28, MASKLWORD, 0x0000);
		} else {
			odm_set_bb_regbu(dm, R_0xa24, MASKDWORD, 0x384f6577);
			odm_set_bb_regbu(dm, R_0xa28, MASKLWORD, 0x1525);
		}
		...
		if (!(dm->rfe_type == 15 || dm->rfe_type == 16)) {
			if (central_ch >= 36 && central_ch <= 64) {
				odm_set_bb_regbu(dm, R_0x958, 0x1f, 0x1);
				dig_tab->agc_table_idx = 0x1;
			} else if ((central_ch >= 100) && (central_ch <= 144)) {
				odm_set_bb_regbu(dm, R_0x958, 0x1f, 0x2);
				dig_tab->agc_table_idx = 0x2;
			} else if (central_ch >= 149) {
				odm_set_bb_regbu(dm, R_0x958, 0x1f, 0x3);
		...
		if (central_ch >= 36 && central_ch <= 48) {
			odm_set_bb_regbu(dm, R_0x860, 0x1ffe0000, 0x494);
		} else if ((central_ch >= 52) && (central_ch <= 64)) {
			odm_set_bb_regbu(dm, R_0x860, 0x1ffe0000, 0x453);
		} else if ((central_ch >= 100) && (central_ch <= 116)) {
			odm_set_bb_regbu(dm, R_0x860, 0x1ffe0000, 0x452);
		} else if ((central_ch >= 118) && (central_ch <= 177)) {
			odm_set_bb_regbu(dm, R_0x860, 0x1ffe0000, 0x412);
		} else {
	...
	if (*dm->mp_mode && (dm->rfe_type == 3 || dm->rfe_type == 5)) {
		if (central_ch == 14)
			odm_write_digbu(dm, 0x26);
		else
			odm_write_digbu(dm, 0x20);
	}
	...
	if (rf_reg_be != 0xff) {
		odm_set_rf_regbu(dm, RF_PATH_A, RF_0xbe, (BIT(17) | BIT(16) |
			       BIT(15)), rf_reg_be);
	} else {
	...
	if (central_ch == 144) {
		odm_set_rf_regbu(dm, RF_PATH_A, RF_0xdf, BIT(18), 0x1);
		rf_reg18 = (rf_reg18 | BIT(17));
	} else {
		odm_set_rf_regbu(dm, RF_PATH_A, RF_0xdf, BIT(18), 0x0);
	...
	odm_set_rf_regbu(dm, RF_PATH_A, RF_0xb8, BIT(19), 0);
	odm_set_rf_regbu(dm, RF_PATH_A, RF_0xb8, BIT(19), 1);
				    ...
				    enum channel_width bw)
{
	...
	case CHANNEL_WIDTH_20: {
		...
		/* rf mode([1:0]) = 20M */
		/* odm_set_bb_regbu(dm, R_0x8ac, MASKBYTE0, CHANNEL_WIDTH_20);*/
#endif

#if 0
		/* @ADC clock = 160M clock for BW20 */
		/* odm_set_bb_regbu(dm, R_0x8ac, (BIT(9) | BIT(8)), 0x0);*/
		/* odm_set_bb_regbu(dm, R_0x8ac, BIT(16), 0x1);*/
#endif

#if 0
		/* @DAC clock = 160M clock for BW20 */
		/* odm_set_bb_regbu(dm, R_0x8ac, (BIT(21) | BIT(20)), 0x0);*/
		/* odm_set_bb_regbu(dm, R_0x8ac, BIT(28), 0x1);*/
#endif

		val32 = odm_get_bb_regbu(dm, R_0x8ac, MASKDWORD);
		val32 &= 0xFFCFFC00;
		val32 |= (CHANNEL_WIDTH_20);
		odm_set_bb_regbu(dm, R_0x8ac, MASKDWORD, val32);

		/* @ADC buffer clock */
		odm_set_bb_regbu(dm, R_0x8c4, BIT(30), 0x1);
	...
	case CHANNEL_WIDTH_40: {
		...
		/* rf mode([1:0]) = 40M */
		/* odm_set_bb_regbu(dm, R_0x8ac, MASKBYTE0, */
		/* @(((primary_ch_idx & 0xf) << 2) | CHANNEL_WIDTH_40));*/

		/* @CCK primary channel */
		if (primary_ch_idx == 1)
			odm_set_bb_regbu(dm, R_0xa00, BIT(4), primary_ch_idx);
		else
			odm_set_bb_regbu(dm, R_0xa00, BIT(4), 0);

#if 0
		/* @ADC clock = 160M clock for BW40 */
		/*odm_set_bb_regbu(dm, R_0x8ac, (BIT(11) | BIT(10)), 0x0);*/
		/*odm_set_bb_regbu(dm, R_0x8ac, BIT(17), 0x1);*/
#endif

#if 0
		/* @DAC clock = 160M clock for BW20 */
		/*odm_set_bb_regbu(dm, R_0x8ac, (BIT(23) | BIT(22)), 0x0);*/
		/*odm_set_bb_regbu(dm, R_0x8ac, BIT(29), 0x1);*/
#endif
	...
	case CHANNEL_WIDTH_80: {
		...
		/*odm_set_bb_regbu(dm, R_0x8ac, (BIT(13) | BIT(12)), 0x0);*/
		/*odm_set_bb_regbu(dm, R_0x8ac, BIT(18), 0x1);*/
#endif

#if 0
		/* @DAC clock = 160M clock for BW20 */
		/*odm_set_bb_regbu(dm, R_0x8ac, (BIT(25) | BIT(24)), 0x0);*/
		/*odm_set_bb_regbu(dm, R_0x8ac, BIT(30), 0x1);*/
#endif
		...
		if (rfe_type == 2 || rfe_type == 3 || rfe_type == 17) {
			odm_set_bb_regbu(dm, R_0x840, 0x0000f000, 0x6);
			odm_set_bb_regbu(dm, R_0x8c8, BIT(10), 0x1);
		}
	...
	case CHANNEL_WIDTH_5: {
...
#if 0
		/* @ADC clock = 40M clock */
		/*odm_set_bb_regbu(dm, R_0x8ac, (BIT(9) | BIT(8)), 0x2);*/
		/*odm_set_bb_regbu(dm, R_0x8ac, BIT(16), 0x0);*/
#endif

#if 0
		/* @DAC clock = 160M clock for BW20 */
		/*odm_set_bb_regbu(dm, R_0x8ac, (BIT(21) | BIT(20)), 0x2);*/
		/*odm_set_bb_regbu(dm, R_0x8ac, BIT(28), 0x0);*/
#endif
		...
		/* @ADC buffer clock */
		odm_set_bb_regbu(dm, R_0x8c4, BIT(30), 0x0);
		odm_set_bb_regbu(dm, R_0x8c8, BIT(31), 0x1);
...
#if 0
		/* @ADC clock = 80M clock */
		/*odm_set_bb_regbu(dm, R_0x8ac, (BIT(9) | BIT(8)), 0x3);*/
		/*odm_set_bb_regbu(dm, R_0x8ac, BIT(16), 0x0);*/
#endif

#if 0
		/* @DAC clock = 160M clock for BW20 */
		/*odm_set_bb_regbu(dm, R_0x8ac, (BIT(21) | BIT(20)), 0x3);*/
		/*odm_set_bb_regbu(dm, R_0x8ac, BIT(28), 0x0);*/
#endif
	...
	odm_set_bb_regbu(dm, R_0x808, MASKBYTE0, 0x0);
	odm_set_bb_regbu(dm, R_0x808, MASKBYTE0, (dm->rx_ant_status |
						(dm->rx_ant_status << 4)));
...
__odm_func__
void
phydm_config_cck_tx_pathbu_8822b(struct dm_struct *dm, enum bb_path tx_path)
{
...
__odm_func__
void
phydm_config_ofdm_tx_pathbu_8822b(struct dm_struct *dm, enum bb_path tx_path_en,
				enum bb_path tx_path_sel_1ss)
{
	/* @Set TX logic map and TX path_en*/
	if (tx_path_en == BB_PATH_A) { /* @1T, 1ss */
		odm_set_bb_regbu(dm, R_0x93c, 0xfff00000, 0x001);
	} else if (tx_path_en == BB_PATH_B) {
		odm_set_bb_regbu(dm, R_0x93c, 0xfff00000, 0x002);
	} else { /*BB_PATH_AB*/
		if (tx_path_sel_1ss == BB_PATH_A) {
			odm_set_bb_regbu(dm, R_0x93c, 0xfff00000, 0x001);
			odm_set_bb_regbu(dm, R_0x940, 0xfff0, 0x043);
		} else if (tx_path_sel_1ss == BB_PATH_B) {
			odm_set_bb_regbu(dm, R_0x93c, 0xfff00000, 0x002);
			odm_set_bb_regbu(dm, R_0x940, 0xfff0, 0x043);
		} else { /*BB_PATH_AB*/
			odm_set_bb_regbu(dm, R_0x93c, 0xfff00000, 0x043);
			odm_set_bb_regbu(dm, R_0x940, 0xfff0, 0x043);
		}
	}
#if 1
	...
	if (tx_path_en == BB_PATH_A || tx_path_en == BB_PATH_B) {
		odm_set_bb_regbu(dm, R_0x940, 0xf0, 0x1);
		odm_set_bb_regbu(dm, R_0x940, 0xff00, 0x0);
	}
#endif
}
				...
				enum bb_path tx_path_sel_cck)
{
	...
	odm_set_bb_regbu(dm, R_0x93c, (BIT(19) | BIT(18)), 0x3);
	odm_set_bb_regbu(dm, R_0x80c, (BIT(29) | BIT(28)), 0x1);

	/* @Control CCK TX path by 0xa07[7] */
	odm_set_bb_regbu(dm, R_0x80c, BIT(30), 0x1);
	/* TX path HW block enable */
	odm_set_bb_regbu(dm, R_0x80c, MASKBYTE0, (tx_path << 4) | tx_path);

	/*---- [CCK] ----*/
	phydm_config_cck_tx_pathbu_8822b(dm, tx_path_sel_cck);

	/*---- [OFDM] ----*/
	#if 1
	phydm_config_ofdm_tx_pathbu_8822b(dm, tx_path, tx_path_sel_1ss);
	#else
	...
	if (tx_path == BB_PATH_A || tx_path == BB_PATH_B)
		odm_set_bb_regbu(dm, R_0x940, 0xfff0, 0x01);
	else
		odm_set_bb_regbu(dm, R_0x940, 0xfff0, 0x43);
...
void phydm_config_rx_path_8822b(struct dm_struct *dm, enum bb_path rx_path)
{
	...
	odm_set_bb_regbu(dm, R_0xa2c, BIT(22), 0x0);
	/*@Disable MRC for CCK barker */
	odm_set_bb_regbu(dm, R_0xa2c, BIT(18), 0x0);

	/* @CCK RX 1st and 2nd path setting*/
	if (rx_path & BB_PATH_A)
		odm_set_bb_regbu(dm, R_0xa04, 0x0f000000, 0x0); /*@00,00*/
	else if (rx_path & BB_PATH_B)
		odm_set_bb_regbu(dm, R_0xa04, 0x0f000000, 0x5); /*@01,01*/

	/* RX path enable */
	odm_set_bb_regbu(dm, R_0x808, MASKBYTE0, (rx_path << 4) | rx_path);

	if (rx_path == BB_PATH_A || rx_path == BB_PATH_B) {
		/* @Disable Antenna weighting */
		odm_set_bb_regbu(dm, R_0x1904, BIT(16), 0x0);
		/* @htstf ant-wgt enable = 0*/
		odm_set_bb_regbu(dm, R_0x800, BIT(28), 0x0);
		/* @MRC_mode  =  'original ZF eqz'*/
		odm_set_bb_regbu(dm, R_0x850, BIT(23), 0x0);
	} else {
		/* @Enable Antenna weighting */
		odm_set_bb_regbu(dm, R_0x1904, BIT(16), 0x1);
		/* @htstf ant-wgt enable = 1*/
		odm_set_bb_regbu(dm, R_0x800, BIT(28), 0x1);
		/* @MRC_mode =  'modified ZF eqz'*/
		odm_set_bb_regbu(dm, R_0x850, BIT(23), 0x1);
	}
}
			    ...
			    enum bb_path tx_path_sel_1ss)
{
	...
	if ((tx_path_en | rx_path) & BB_PATH_A)
		odm_set_bb_regbu(dm, R_0xc08, MASKLWORD, 0x3231);
	else
		odm_set_bb_regbu(dm, R_0xc08, MASKLWORD, 0x1111);

	if ((tx_path_en | rx_path) & BB_PATH_B)
		odm_set_bb_regbu(dm, R_0xe08, MASKLWORD, 0x3231);
	else
		odm_set_bb_regbu(dm, R_0xe08, MASKLWORD, 0x1111);
	...
	while (1) {
		counter++;
		odm_set_rf_regbu(dm, RF_PATH_A, RF_0xef, RFREG_MASK, 0x80000);
		odm_set_rf_regbu(dm, RF_PATH_A, RF_0x33, RFREG_MASK, 0x00001);
	...
	if (*dm->mp_mode || *dm->antenna_test || dm->normal_rx_path ||
		...
		odm_set_rf_regbu(dm, RF_PATH_A, RF_0xef, RFREG_MASK, 0x80000);
		odm_set_rf_regbu(dm, RF_PATH_A, RF_0x33, RFREG_MASK, 0x00001);
		odm_set_rf_regbu(dm, RF_PATH_A, RF_0x3e, RFREG_MASK, 0x00034);
		odm_set_rf_regbu(dm, RF_PATH_A, RF_0x3f, RFREG_MASK, 0x4080e);
		odm_set_rf_regbu(dm, RF_PATH_A, RF_0xef, RFREG_MASK, 0x00000);
		PHYDM_DBG(dm, ODM_PHY_CONFIG,
		...
		odm_set_rf_regbu(dm, RF_PATH_A, RF_0x33, RFREG_MASK, 0x00001);
		odm_set_rf_regbu(dm, RF_PATH_A, RF_0x3e, RFREG_MASK, 0x00034);
		odm_set_rf_regbu(dm, RF_PATH_A, RF_0x3f, RFREG_MASK, 0x4080c);
		odm_set_rf_regbu(dm, RF_PATH_A, RF_0xef, RFREG_MASK, 0x00000);
		PHYDM_DBG(dm, ODM_PHY_CONFIG,
				  ...
				  enum odm_parameter_init type)
{
	if (type == ODM_PRE_SETTING) {
		odm_set_bb_regbu(dm, R_0x808, (BIT(28) | BIT(29)), 0x0);
		PHYDM_DBG(dm, ODM_PHY_CONFIG,
			  "Pre set: disable OFDM/CCK block\n");
	} else if (type == ODM_POST_SETTING) {
		odm_set_bb_regbu(dm, R_0x808, (BIT(28) | BIT(29)), 0x3);
		PHYDM_DBG(dm, ODM_PHY_CONFIG,
