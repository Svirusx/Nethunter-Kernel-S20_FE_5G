...
void phydm_radar_detect_reset(void *dm_void)
{
	...
	if (dm->support_ic_type & (ODM_RTL8198F | ODM_RTL8822C | ODM_RTL8812F |
		...
		odm_set_bb_regbu(dm, R_0xa40, BIT(15), 0);
		odm_set_bb_regbu(dm, R_0xa40, BIT(15), 1);
	#if (RTL8721D_SUPPORT)
	} else if (dm->support_ic_type & (ODM_RTL8721D)) {
		odm_set_bb_regbu(dm, R_0xf58, BIT(29), 0);
		odm_set_bb_regbu(dm, R_0xf58, BIT(29), 1);
	#endif
	} else if (dm->support_ic_type & (ODM_RTL8814B)) {
		if (dm->seg1_dfs_flag == 1) {
			odm_set_bb_regbu(dm, R_0xa6c, BIT(0), 0);
			odm_set_bb_regbu(dm, R_0xa6c, BIT(0), 1);
			return;
		}
		odm_set_bb_regbu(dm, R_0xa40, BIT(15), 0);
		odm_set_bb_regbu(dm, R_0xa40, BIT(15), 1);
	} else {
		odm_set_bb_regbu(dm, R_0x924, BIT(15), 0);
		odm_set_bb_regbu(dm, R_0x924, BIT(15), 1);
	}
}
...
static void phydm_radar_detect_with_dbg_parm(void *dm_void)
{
	...
	if (dm->support_ic_type & ODM_RTL8721D) {
		odm_set_bb_regbu(dm, R_0xf54, MASKDWORD,
			       dm->radar_detect_reg_f54);
		odm_set_bb_regbu(dm, R_0xf58, MASKDWORD,
			       dm->radar_detect_reg_f58);
		odm_set_bb_regbu(dm, R_0xf5c, MASKDWORD,
			       dm->radar_detect_reg_f5c);
		odm_set_bb_regbu(dm, R_0xf70, MASKDWORD,
			       dm->radar_detect_reg_f70);
		odm_set_bb_regbu(dm, R_0xf74, MASKDWORD,
			       dm->radar_detect_reg_f74);
	} else if (dm->support_ic_type & ODM_IC_JGR3_SERIES) {
		odm_set_bb_regbu(dm, R_0xa40, MASKDWORD,
			       dm->radar_detect_reg_a40);
		odm_set_bb_regbu(dm, R_0xa44, MASKDWORD,
			       dm->radar_detect_reg_a44);
		odm_set_bb_regbu(dm, R_0xa48, MASKDWORD,
			       dm->radar_detect_reg_a48);
		odm_set_bb_regbu(dm, R_0xa4c, MASKDWORD,
			       dm->radar_detect_reg_a4c);
		odm_set_bb_regbu(dm, R_0xa50, MASKDWORD,
			       dm->radar_detect_reg_a50);
		odm_set_bb_regbu(dm, R_0xa54, MASKDWORD,
			       dm->radar_detect_reg_a54);
	} else {
		odm_set_bb_regbu(dm, R_0x918, MASKDWORD,
			       dm->radar_detect_reg_918);
		odm_set_bb_regbu(dm, R_0x91c, MASKDWORD,
			       dm->radar_detect_reg_91c);
		odm_set_bb_regbu(dm, R_0x920, MASKDWORD,
			       dm->radar_detect_reg_920);
		odm_set_bb_regbu(dm, R_0x924, MASKDWORD,
...
void phydm_radar_detect_enable(void *dm_void)
{
	...
	if (dm->support_ic_type & (ODM_RTL8821 | ODM_RTL8812 | ODM_RTL8881A)) {
		odm_set_bb_regbu(dm, R_0x814, 0x3fffffff, 0x04cc4d10);
		odm_set_bb_regbu(dm, R_0x834, MASKBYTE0, 0x06);
		...
		if (region_domain == PHYDM_DFS_DOMAIN_ETSI) {
			odm_set_bb_regbu(dm, R_0x918, MASKDWORD, 0x1c17ecdf);
			odm_set_bb_regbu(dm, R_0x924, MASKDWORD, 0x01528500);
			odm_set_bb_regbu(dm, R_0x91c, MASKDWORD, 0x0fa21a20);
			odm_set_bb_regbu(dm, R_0x920, MASKDWORD, 0xe0f69204);

		} else if (region_domain == PHYDM_DFS_DOMAIN_MKK) {
			odm_set_bb_regbu(dm, R_0x924, MASKDWORD, 0x01528500);
			odm_set_bb_regbu(dm, R_0x920, MASKDWORD, 0xe0d67234);
			...
			odm_set_bb_regbu(dm, R_0x918, MASKDWORD, 0x1c16acdf);
			odm_set_bb_regbu(dm, R_0x924, MASKDWORD, 0x01528500);
			odm_set_bb_regbu(dm, R_0x920, MASKDWORD, 0xe0d67231);
			if (band_width == CHANNEL_WIDTH_20)
				odm_set_bb_regbu(dm, R_0x91c, MASKDWORD,
					       0x64741a20);
			else
		...
		if (dm->support_ic_type & (ODM_RTL8822B | ODM_RTL8821C)) {
			if (band_width == CHANNEL_WIDTH_20)
				odm_set_bb_regbu(dm, R_0x1984, BIT(26), 1);
			else
				odm_set_bb_regbu(dm, R_0x1984, BIT(26), 0);
		}
		...
		if (region_domain == PHYDM_DFS_DOMAIN_ETSI) {
			odm_set_bb_regbu(dm, R_0x918, MASKDWORD, 0x1c16acdf);
			odm_set_bb_regbu(dm, R_0x924, MASKDWORD, 0x095a8500);
			odm_set_bb_regbu(dm, R_0x91c, MASKDWORD, 0x0fc01a1f);
			odm_set_bb_regbu(dm, R_0x920, MASKDWORD, 0xe0f57204);
			...
			odm_set_bb_regbu(dm, R_0x918, MASKDWORD, 0x1c176cdf);
			odm_set_bb_regbu(dm, R_0x924, MASKDWORD, 0x095a8400);
			odm_set_bb_regbu(dm, R_0x920, MASKDWORD, 0xe076d231);
			if (band_width == CHANNEL_WIDTH_20)
				odm_set_bb_regbu(dm, R_0x91c, MASKDWORD,
					       0x64901a1f);
			else
		 ...
		 */
		if (dm->support_ic_type & (ODM_RTL8822B | ODM_RTL8821C)) {
			if (odm_get_bb_regbu(dm, 0x8d8,
					   BIT28 | BIT27 | BIT26) == 0) {
				short_pw_upperbound =
					(u8)odm_get_bb_regbu(dm, 0x91c,
						       BIT23 | BIT22 |
						       BIT21 | BIT20);
				if ((short_pw_upperbound + 4) > 15)
					odm_set_bb_regbu(dm, 0x91c,
						       BIT23 | BIT22 |
						       BIT21 | BIT20, 15);
				else
					odm_set_bb_regbu(dm, 0x91c,
			...
			odm_set_bb_regbu(dm, 0x19e4, 0x003C0000, 13);
			odm_set_bb_regbu(dm, 0x924, 0x70000, 0);
		}

		if (dm->support_ic_type & (ODM_RTL8881A))
			odm_set_bb_regbu(dm, 0xb00, 0xc0000000, 3);

		/*@for 8814 new dfs mechanism setting*/
		if (dm->support_ic_type &
		    (ODM_RTL8814A | ODM_RTL8822B | ODM_RTL8821C)) {
			/*Turn off dfs scaling factor*/
			odm_set_bb_regbu(dm, 0x19e4, 0x1fff, 0x0c00);
			/*NonDC peak_th = 2times DC peak_th*/
			odm_set_bb_regbu(dm, 0x19e4, 0x30000, 1);
			/*power for debug and auto test flow latch after ST*/
			odm_set_bb_regbu(dm, 0x9f8, 0xc0000000, 3);
			...
			/*@ETSI*/
				...
				/*pulse width hist th setting*/
				/*th1=2*04us*/
				odm_set_bb_regbu(dm, 0x19e4, 0xff000000, 1);
				odm_set_bb_regbu(dm, 0x19e8,
					       MASKDWORD, 0x68260d06);
				/*PRI hist th setting*/
				/*th1=7*32us*/
				odm_set_bb_regbu(dm, 0x19b8, 0x00007f80, 7);
			...
			/*@FCC*/
				...
				/*pulse width hist th setting*/
				/*th1=2*04us*/
				odm_set_bb_regbu(dm, 0x19e4, 0xff000000, 2);
				/*th2 = 13*0.4us, th3 = 26*0.4us,
				 *th4 = 75*0.4us, th5 = 255*0.4us
				 */
				odm_set_bb_regbu(dm, 0x19e8,
				...
				/*PRI hist th setting*/
				/*th1=4*32us*/
				odm_set_bb_regbu(dm, 0x19b8, 0x00007f80, 4);
		...
		if (region_domain == PHYDM_DFS_DOMAIN_ETSI) {
			odm_set_bb_regbu(dm, R_0xa40, MASKDWORD, 0xb359c5bd);
			if (dm->support_ic_type & (ODM_RTL8814B)) {
				if (dm->seg1_dfs_flag == 1)
					odm_set_bb_regbu(dm, R_0xa6c, BIT(0), 1);
			}
			odm_set_bb_regbu(dm, R_0xa44, MASKDWORD, 0x3033bebd);
			odm_set_bb_regbu(dm, R_0xa48, MASKDWORD, 0x2a521254);
			odm_set_bb_regbu(dm, R_0xa4c, MASKDWORD, 0xa2533345);
			odm_set_bb_regbu(dm, R_0xa50, MASKDWORD, 0x605be003);
			odm_set_bb_regbu(dm, R_0xa54, MASKDWORD, 0x500089e8);
		} else if (region_domain == PHYDM_DFS_DOMAIN_MKK) {
			odm_set_bb_regbu(dm, R_0xa40, MASKDWORD, 0xb359c5bd);
			if (dm->support_ic_type & (ODM_RTL8814B)) {
				if (dm->seg1_dfs_flag == 1)
		...
		odm_set_bb_regbu(dm, R_0x814, 0x3fffffff, 0x04cc4d10);
		/*CCA MASK*/
		odm_set_bb_regbu(dm, R_0xc38, 0x07c00000, 0x06);
		/*CCA Threshold*/
		odm_set_bb_regbu(dm, R_0xc3c, 0x00000007, 0x0);
		...
		if (region_domain == PHYDM_DFS_DOMAIN_ETSI) {
			odm_set_bb_regbu(dm, R_0xf54, MASKDWORD, 0x230006a8);
			odm_set_bb_regbu(dm, R_0xf58, MASKDWORD, 0x354cd7dd);
			odm_set_bb_regbu(dm, R_0xf5c, MASKDWORD, 0x9984ab25);
			odm_set_bb_regbu(dm, R_0xf70, MASKDWORD, 0xbd9fab98);
			odm_set_bb_regbu(dm, R_0xf74, MASKDWORD, 0xcc45029f);

		} else if (region_domain == PHYDM_DFS_DOMAIN_MKK) {
			odm_set_bb_regbu(dm, R_0xf54, MASKDWORD, 0x230006a8);
			odm_set_bb_regbu(dm, R_0xf5c, MASKDWORD, 0x9984ab25);
			odm_set_bb_regbu(dm, R_0xf70, MASKDWORD, 0xbd9fb398);
			odm_set_bb_regbu(dm, R_0xf74, MASKDWORD, 0xcc450e9d);
			...
			odm_set_bb_regbu(dm, R_0xf54, MASKDWORD, 0x230006a8);
			odm_set_bb_regbu(dm, R_0xf58, MASKDWORD, 0x3558d7bd);
			odm_set_bb_regbu(dm, R_0xf5c, MASKDWORD, 0x9984ab35);
			odm_set_bb_regbu(dm, R_0xf70, MASKDWORD, 0xbd9fb398);
			odm_set_bb_regbu(dm, R_0xf74, MASKDWORD, 0xcc444e9d);
		} else {
			/* not supported */
			PHYDM_DBG(dm, DBG_DFS,
				  "Unsupported dfs_region_domain:%d\n",
		...
		/*if peak index -1~+1, use original NB method*/
		odm_set_bb_regbu(dm, R_0xf70, 0x00070000, 0x7);
		odm_set_bb_regbu(dm, R_0xf74, 0x000c0000, 0);

		/*Turn off dfs scaling factor*/
		odm_set_bb_regbu(dm, R_0xf70, 0x00080000, 0x0);
		/*NonDC peak_th = 2times DC peak_th*/
		odm_set_bb_regbu(dm, R_0xf58, 0x00007800, 1);

		/*low pulse width radar pattern will cause wrong drop*/
		/*disable peak index should the same*/
		/*during the same short pulse (new mechan)*/
		odm_set_bb_regbu(dm, R_0xf70, 0x00100000, 0x0);
		/*if peak index diff >=2, then drop the result*/
		odm_set_bb_regbu(dm, R_0xf70, 0x30000000, 0x2);
	#endif
	} else {
	...
	if (dm->support_ic_type & ODM_IC_JGR3_SERIES) {
		dfs->st_l2h_cur = (u8)odm_get_bb_regbu(dm, R_0xa40, 0x00007f00);
		dfs->pwdb_th_cur = (u8)odm_get_bb_regbu(dm, R_0xa50, 0x000000f0);
		dfs->peak_th = (u8)odm_get_bb_regbu(dm, R_0xa48, 0x00c00000);
		dfs->short_pulse_cnt_th = (u8)odm_get_bb_regbu(dm, R_0xa50,
							     0x00f00000);
		dfs->long_pulse_cnt_th = (u8)odm_get_bb_regbu(dm, R_0xa4c,
							    0xf0000000);
		dfs->peak_window = (u8)odm_get_bb_regbu(dm, R_0xa40, 0x00030000);
		dfs->three_peak_opt = (u8)odm_get_bb_regbu(dm, R_0xa40,
							 0x30000000);
		dfs->three_peak_th2 = (u8)odm_get_bb_regbu(dm, R_0xa44,
							 0x00000007);
	#if (RTL8721D_SUPPORT)
	} else if (dm->support_ic_type & (ODM_RTL8721D)) {
		dfs->st_l2h_cur = (u8)odm_get_bb_regbu(dm, R_0xf54,
						     0x0000001f) << 2);
		dfs->st_l2h_cur += (u8)odm_get_bb_regbu(dm, R_0xf58, 0xc0000000);
		dfs->pwdb_th_cur = (u8)odm_get_bb_regbu(dm, R_0xf70, 0x03c00000);
		dfs->peak_th = (u8)odm_get_bb_regbu(dm, R_0xf5c, 0x00000030);
		dfs->short_pulse_cnt_th = (u8)odm_get_bb_regbu(dm, R_0xf70,
							     0x00007800);
		dfs->long_pulse_cnt_th = (u8)odm_get_bb_regbu(dm, R_0xf74,
							    0x0000000f);
		dfs->peak_window = (u8)odm_get_bb_regbu(dm, R_0xf58, 0x18000000);
		dfs->three_peak_opt = (u8)odm_get_bb_regbu(dm, R_0xf58,
							 0x00030000);
		dfs->three_peak_th2 = (u8)odm_get_bb_regbu(dm,
							 R_0xf58, 0x00007c00);
	#endif
	} else {
		dfs->st_l2h_cur = (u8)odm_get_bb_regbu(dm, R_0x91c, 0x000000ff);
		dfs->pwdb_th_cur = (u8)odm_get_bb_regbu(dm, R_0x918, 0x00001f00);
		dfs->peak_th = (u8)odm_get_bb_regbu(dm, R_0x918, 0x00030000);
		dfs->short_pulse_cnt_th = (u8)odm_get_bb_regbu(dm, R_0x920,
							     0x000f0000);
		dfs->long_pulse_cnt_th = (u8)odm_get_bb_regbu(dm, R_0x920,
							    0x00f00000);
		dfs->peak_window = (u8)odm_get_bb_regbu(dm, R_0x920, 0x00000300);
		dfs->three_peak_opt = (u8)odm_get_bb_regbu(dm, 0x924, 0x00000180);
		dfs->three_peak_th2 = (u8)odm_get_bb_regbu(dm, 0x924, 0x00007000);
	}
	...
	void *dm_void)
{
	...
	if (dm->support_ic_type & ODM_IC_JGR3_SERIES) {
		if (dfs->peak_th != peak_th_cur)
			odm_set_bb_regbu(dm, R_0xa48, 0x00c00000, peak_th_cur);
		if (dfs->short_pulse_cnt_th != short_pulse_cnt_th_cur)
			odm_set_bb_regbu(dm, R_0xa50, 0x00f00000,
				       short_pulse_cnt_th_cur);
		if (dfs->long_pulse_cnt_th != long_pulse_cnt_th_cur)
			odm_set_bb_regbu(dm, R_0xa4c, 0xf0000000,
				       long_pulse_cnt_th_cur);
		if (dfs->peak_window != peak_window_cur)
			odm_set_bb_regbu(dm, R_0xa40, 0x00030000,
				       peak_window_cur);
		if (dfs->three_peak_opt != three_peak_opt_cur)
			odm_set_bb_regbu(dm, R_0xa40, 0x30000000,
				       three_peak_opt_cur);
		if (dfs->three_peak_th2 != three_peak_th2_cur)
			odm_set_bb_regbu(dm, R_0xa44, 0x00000007,
				       three_peak_th2_cur);
	#if (RTL8721D_SUPPORT)
	} else if (dm->support_ic_type & (ODM_RTL8721D)) {
		if (dfs->peak_th != peak_th_cur)
			odm_set_bb_regbu(dm, R_0xf5c, 0x00000030, peak_th_cur);
		if (dfs->short_pulse_cnt_th != short_pulse_cnt_th_cur)
			odm_set_bb_regbu(dm, R_0xf70, 0x00007800,
				       short_pulse_cnt_th_cur);
		if (dfs->long_pulse_cnt_th != long_pulse_cnt_th_cur)
			odm_set_bb_regbu(dm, R_0xf74, 0x0000000f,
				       long_pulse_cnt_th_cur);
		if (dfs->peak_window != peak_window_cur)
			odm_set_bb_regbu(dm, R_0xf58, 0x18000000,
				       peak_window_cur);
		if (dfs->three_peak_opt != three_peak_opt_cur)
			odm_set_bb_regbu(dm, R_0xf58, 0x00030000,
				       three_peak_opt_cur);
		if (dfs->three_peak_th2 != three_peak_th2_cur)
			odm_set_bb_regbu(dm, R_0xf58, 0x00007c00,
				       three_peak_th2_cur);
	#endif
	} else {
		if (dfs->peak_th != peak_th_cur)
			odm_set_bb_regbu(dm, R_0x918, 0x00030000, peak_th_cur);
		if (dfs->short_pulse_cnt_th != short_pulse_cnt_th_cur)
			odm_set_bb_regbu(dm, R_0x920, 0x000f0000,
				       short_pulse_cnt_th_cur);
		if (dfs->long_pulse_cnt_th != long_pulse_cnt_th_cur)
			odm_set_bb_regbu(dm, R_0x920, 0x00f00000,
				       long_pulse_cnt_th_cur);
		if (dfs->peak_window != peak_window_cur)
			odm_set_bb_regbu(dm, R_0x920, 0x00000300,
				       peak_window_cur);
		if (dfs->three_peak_opt != three_peak_opt_cur)
			odm_set_bb_regbu(dm, R_0x924, 0x00000180,
				       three_peak_opt_cur);
		if (dfs->three_peak_th2 != three_peak_th2_cur)
			odm_set_bb_regbu(dm, R_0x924, 0x00007000,
				       three_peak_th2_cur);
	}
	...
	void *dm_void)
{
	...
	if (dm->support_ic_type & ODM_IC_JGR3_SERIES)
		fa_count_cur = (u16)odm_get_bb_regbu(dm, R_0x2d00, MASKLWORD);
	#if (RTL8721D_SUPPORT)
	else if (dm->support_ic_type & (ODM_RTL8721D)) {
		fa_count_cur = (u16)odm_get_bb_regbu(dm,
		...
		fa_count_cur = (u16)odm_get_bb_regbu(dm, R_0xf48, 0x0000ffff);
	...
	if (dm->support_ic_type & (ODM_RTL8198F | ODM_RTL8822C | ODM_RTL8812F |
				   ODM_RTL8197G| ODM_RTL8723F)) {
		radar_rpt_reg_value = odm_get_bb_regbu(dm, R_0x2e00, 0xffffffff);
		...
		reg908_value = (u32)odm_get_bb_regbu(dm, R_0x908, MASKDWORD);
		odm_set_bb_regbu(dm, R_0x908, MASKDWORD, 0x254);
		regdf4_value = odm_get_bb_regbu(dm, R_0xdf4, MASKDWORD);
		...
		if (dm->seg1_dfs_flag == 1)
			radar_rpt_reg_value = odm_get_bb_regbu(dm, R_0x2e20,
							     0xffffffff);
		else
			radar_rpt_reg_value = odm_get_bb_regbu(dm, R_0x2e00,
							     0xffffffff);
		short_pulse_cnt_cur = (u16)((radar_rpt_reg_value & 0x000ff800)
					    >> 11);
		long_pulse_cnt_cur = (u16)((radar_rpt_reg_value & 0x0fc00000)
		...
		regf98_value = odm_get_bb_regbu(dm, R_0xf98, 0xffffffff);
	...
	if (dfs->det_print) {
		...
		if (dm->support_ic_type & (ODM_RTL8721D)) {
			...
			regf54_value = odm_get_bb_regbu(dm, R_0xf54, MASKDWORD);
			regf58_value = odm_get_bb_regbu(dm, R_0xf58, MASKDWORD);
			regf5c_value = odm_get_bb_regbu(dm, R_0xf5c, MASKDWORD);
			regf70_value = odm_get_bb_regbu(dm, R_0xf70, MASKDWORD);
			regf74_value = odm_get_bb_regbu(dm, R_0xf74, MASKDWORD);
			PHYDM_DBG(dm, DBG_DFS,
			...
			PHYDM_DBG(dm, DBG_DFS,
				  ...
				  long_pulse_cnt_inc);
		#if (RTL8812F_SUPPORT || RTL8822C_SUPPORT || RTL8814B_SUPPORT)
			rega40_value = odm_get_bb_regbu(dm, R_0xa40, MASKDWORD);
			rega44_value = odm_get_bb_regbu(dm, R_0xa44, MASKDWORD);
			rega48_value = odm_get_bb_regbu(dm, R_0xa48, MASKDWORD);
			rega4c_value = odm_get_bb_regbu(dm, R_0xa4c, MASKDWORD);
			rega50_value = odm_get_bb_regbu(dm, R_0xa50, MASKDWORD);
			rega54_value = odm_get_bb_regbu(dm, R_0xa54, MASKDWORD);
			PHYDM_DBG(dm, DBG_DFS,
			...
			PHYDM_DBG(dm, DBG_DFS,
				  ...
				  short_pulse_cnt_inc, long_pulse_cnt_inc);
			reg918_value = odm_get_bb_regbu(dm, R_0x918,
						      0xffffffff);
			reg91c_value = odm_get_bb_regbu(dm, R_0x91c,
						      0xffffffff);
			reg920_value = odm_get_bb_regbu(dm, R_0x920,
						      0xffffffff);
			reg924_value = odm_get_bb_regbu(dm, R_0x924,
						      0xffffffff);
			PHYDM_DBG(dm, DBG_DFS,
	...
	if (st_l2h_new != dfs->st_l2h_cur) {
		...
		/*odm_set_bb_regbu(dm, R_0x91c, 0xff, dfs->st_l2h_cur);*/
		...
		if (dm->support_ic_type & ODM_IC_JGR3_SERIES)
			odm_set_bb_regbu(dm, R_0xa50, 0x000000f0,
				       dfs->pwdb_th_cur);
		#if (RTL8721D_SUPPORT)
		else if (dm->support_ic_type & ODM_RTL8721D) {
			odm_set_bb_regbu(dm, R_0xf54, 0x0000001f,
				       ((dfs->st_l2h_cur & 0x0000007c) >> 2));
			odm_set_bb_regbu(dm, R_0xf58, 0xc0000000,
				       (dfs->st_l2h_cur & 0x00000003));
			odm_set_bb_regbu(dm, R_0xf70, 0x03c00000,
				       dfs->pwdb_th_cur);
		}
		#endif
		else
			odm_set_bb_regbu(dm, R_0x918, 0x00001f00,
				       dfs->pwdb_th_cur);
	}
	...
	#if (RTL8721D_SUPPORT)
	if (dm->support_ic_type & (ODM_RTL8721D))
		odm_set_bb_regbu(dm, R_0x908, MASKDWORD, reg908_value);
	#endif
	...
	void *dm_void)
{
	...
	odm_set_bb_regbu(dm, 0x19e4, BIT(22) | BIT(23), 0x1);
	dfs_hist1_pw = odm_get_bb_regbu(dm, 0xf5c, 0xffffffff);
	dfs_hist2_pw = odm_get_bb_regbu(dm, 0xf74, 0xffffffff);
	...
	odm_set_bb_regbu(dm, 0x19e4, BIT(22) | BIT(23), 0x3);
	dfs_hist1_pri = odm_get_bb_regbu(dm, 0xf5c, 0xffffffff);
	dfs_hist2_pri = odm_get_bb_regbu(dm, 0xf74, 0xffffffff);
	odm_set_bb_regbu(dm, 0x19b4, 0x10000000, 1); /*reset histo report*/
	odm_set_bb_regbu(dm, 0x19b4, 0x10000000, 0); /*@continue histo report*/
	...
	if (dfs->print_hist_rpt) {
		dfs_pw_thd1 = (u8)odm_get_bb_regbu(dm, 0x19e4, 0xff000000);
		dfs_pw_thd2 = (u8)odm_get_bb_regbu(dm, 0x19e8, 0x000000ff);
		dfs_pw_thd3 = (u8)odm_get_bb_regbu(dm, 0x19e8, 0x0000ff00);
		dfs_pw_thd4 = (u8)odm_get_bb_regbu(dm, 0x19e8, 0x00ff0000);
		dfs_pw_thd5 = (u8)odm_get_bb_regbu(dm, 0x19e8, 0xff000000);

		dfs_pri_thd1 = (u8)odm_get_bb_regbu(dm, 0x19b8, 0x7F80);
		dfs_pri_thd2 = (u8)odm_get_bb_regbu(dm, 0x19ec, 0x000000ff);
		dfs_pri_thd3 = (u8)odm_get_bb_regbu(dm, 0x19ec, 0x0000ff00);
		dfs_pri_thd4 = (u8)odm_get_bb_regbu(dm, 0x19ec, 0x00ff0000);
		dfs_pri_thd5 = (u8)odm_get_bb_regbu(dm, 0x19ec, 0xff000000);
...
boolean phydm_radar_detect(void *dm_void)
{
	...
	if (dm->support_ic_type & ODM_IC_JGR3_SERIES) {
		dfs->igi_cur = (u8)odm_get_bb_regbu(dm, R_0x1d70, 0x0000007f);
		dfs->st_l2h_cur = (u8)odm_get_bb_regbu(dm, R_0xa40, 0x00007f00);
	#if (RTL8721D_SUPPORT)
	} else if (dm->support_ic_type & (ODM_RTL8721D)) {
		dfs->st_l2h_cur = (u8)(odm_get_bb_regbu(dm, R_0xf54,
		...
		dfs->igi_cur = (u8)odm_get_bb_regbu(dm, R_0xc50, 0x0000007f);
		dfs->st_l2h_cur = (u8)odm_get_bb_regbu(dm, R_0x91c, 0x000000ff);
	}
...
boolean
phydm_is_dfs_bandbu(void *dm_void)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
...
boolean
phydm_dfs_master_enabledbu(void *dm_void)
{
