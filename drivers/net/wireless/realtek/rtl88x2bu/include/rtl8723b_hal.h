...
u8 SetHwRegbu8723B(PADAPTER padapter, u8 variable, u8 *val);
void GetHwRegbu8723B(PADAPTER padapter, u8 variable, u8 *val);
u8 SetHalDefVarbu8723B(PADAPTER padapter, HAL_DEF_VARIABLE variable, void *pval);
u8 GetHalDefVarbu8723B(PADAPTER padapter, HAL_DEF_VARIABLE variable, void *pval);
...
u8 MRateToHwRatebu8723B(u8  rate);
