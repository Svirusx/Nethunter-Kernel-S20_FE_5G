...
u8 SetHwRegbu8812A(PADAPTER padapter, u8 variable, u8 *pval);
void GetHwRegbu8812A(PADAPTER padapter, u8 variable, u8 *pval);
u8 SetHalDefVarbu8812A(PADAPTER padapter, HAL_DEF_VARIABLE variable, void *pval);
u8 GetHalDefVarbu8812A(PADAPTER padapter, HAL_DEF_VARIABLE variable, void *pval);
