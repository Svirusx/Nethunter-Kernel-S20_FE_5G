...
ifeq ($(CONFIG_ICNSS), y)	
	WLAN_ROOT := drivers/net/wireless/qualcomm/wcn39xx/qcacld-3.0
else
	WLAN_ROOT := drivers/net/wireless/qualcomm/qca6390/qcacld-3.0
endif
...
cppflags-$(CONFIG_LITHIUM) += -DCONFIG_LITHIUM
...
EXTRA_CFLAGS += -DSEC_CONFIG_WLAN_BEACON_CHECK
endif
