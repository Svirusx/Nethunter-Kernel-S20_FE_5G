...
#define QWLAN_VERSION_EXTRA            "Q-HS201123B"
#elif defined(QCA_WIFI_QCA6490) // Hastings Prime
#define QWLAN_VERSION_EXTRA            "Q-HP201123B"
#else
#define QWLAN_VERSION_EXTRA            "Q-QCOM"
#endif
#else
#define QWLAN_VERSION_EXTRA            "Q-HL201123B"
#endif
#define QWLAN_VERSION_BUILD            3

#if defined(CONFIG_LITHIUM)
#if defined(QCA_WIFI_QCA6390) //Hastings
#define QWLAN_VERSIONSTR               "5.2.022.3Q-HS201123B"
#elif defined(QCA_WIFI_QCA6490) // Hastings Prime
#define QWLAN_VERSIONSTR               "5.2.022.3Q-HP201123B"
#else
#define QWLAN_VERSIONSTR               "5.2.022.3Q-QCOM"
#endif
#else
#define QWLAN_VERSIONSTR               "5.2.022.3Q-HL201123B"
#endif
