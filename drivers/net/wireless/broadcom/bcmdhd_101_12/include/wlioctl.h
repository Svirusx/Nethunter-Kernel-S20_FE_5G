...
typedef enum wl_proxd_session_flags {
	...
	WL_PROXD_SESSION_FLAG_CORE_ROTATE	= 0x00000004, /**< core rotation on initiator */
...
#define WL_FTM_SESSION_FLAG_ONE_WAY              0x0000000000000004llu  /**< 1-way rtt */
...
#define WL_FTM_SESSION_FLAG_AUTO_VHTACK          0x0000000000800000llu /* vhtack based on brcm ie */
...
enum wl_otp_xtlv_id {
	...
	WL_OTP_XTLV_SBOOT_SECURE_REGION_LOCK	= 18u,	/* Secure region lock 5 bits */
...
typedef enum wlc_sta_pm_sc_ofld_exit_reason {
	...
	STA_PM_SC_OFLD_EXIT_SLOTTED_BSS,	/* Exit due to Slotted BSS active */
	STA_PM_SC_OFLD_EXIT_AP_BSS,		/* Exit due to AP BSS active */
	STA_PM_SC_OFLD_EXIT_BTMC_ACTIVE,	/* Exit due to BT Main core activity */
