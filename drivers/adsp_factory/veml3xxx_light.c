...
#ifdef CONFIG_VEML3328_FACTORY
#define CHIP_ID "VEML3328"
#elif CONFIG_VEML3235_FACTORY
#define CHIP_ID "VEML3235"
#else
#define CHIP_ID "VEML3xxx"
#endif
/*************************************************************************/
/* factory Sysfs							 */
/*************************************************************************/
...
static int __init veml3xxx_light_factory_init(void)
{
...
static void __exit veml3xxx_light_factory_exit(void)
{
	adsp_factory_unregister(MSG_LIGHT);

	pr_info("[FACTORY] %s\n", __func__);
}
module_init(veml3xxx_light_factory_init);
module_exit(veml3xxx_light_factory_exit);
